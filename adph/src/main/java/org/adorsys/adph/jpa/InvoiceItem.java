...
@Entity
@Description("org.adorsys.adph.jpa.InvoiceItem.description")
public class InvoiceItem implements Serializable
{
   ...
   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.indexLine.description")
   private int indexLine;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.pic.description")
   private String pic;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.picm.description")
   private String picm;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.designation.description")
   private String designation;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.purchasedQty.description")
   private BigDecimal purchasedQty;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.returnedQty.description")
   private BigDecimal returnedQty;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.salesPricePU.description")
   private BigDecimal salesPricePU;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.discountAmount.description")
   private BigDecimal discountAmount;

   @Column
   @Description("org.adorsys.adph.jpa.InvoiceItem.totalSalesPrice.description")
