...
import org.adorsys.adph.server.jpa.VAT_;
import org.adorsys.adph.server.jpa.VATSearchInput;
import org.adorsys.adph.server.repo.VATRepository;
...
public class VATEndpoint
{
   ...
   {
      VAT saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<VAT> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<VAT> findBy(VATSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<VAT> findByLike(VATSearchInput searchInput)
   {
      SingularAttribute<VAT, ?>[] attributes = readSeachAttributes(searchInput);
