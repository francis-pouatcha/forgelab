...
import org.adorsys.adph.server.jpa.PackagingMode_;
import org.adorsys.adph.server.jpa.PackagingModeSearchInput;
import org.adorsys.adph.server.repo.PackagingModeRepository;
...
public class PackagingModeEndpoint
{
   ...
   {
      PackagingMode saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<PackagingMode> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<PackagingMode> findBy(PackagingModeSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<PackagingMode> findByLike(PackagingModeSearchInput searchInput)
   {
      SingularAttribute<PackagingMode, ?>[] attributes = readSeachAttributes(searchInput);
