...
import org.adorsys.adph.server.jpa.Supplier_;
import org.adorsys.adph.server.jpa.SupplierSearchInput;
import org.adorsys.adph.server.repo.SupplierRepository;
...
public class SupplierEndpoint
{
   ...
   @GET
   @Produces("application/json")
   public List<Supplier> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<Supplier> findBy(SupplierSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<Supplier> findByLike(SupplierSearchInput searchInput)
   {
      SingularAttribute<Supplier, ?>[] attributes = readSeachAttributes(searchInput);
