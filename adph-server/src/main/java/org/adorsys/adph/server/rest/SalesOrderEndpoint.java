...
import org.adorsys.adph.server.jpa.SalesOrder_;
import org.adorsys.adph.server.jpa.SalesOrderSearchInput;
import org.adorsys.adph.server.repo.SalesOrderRepository;
...
public class SalesOrderEndpoint
{
   ...
   @GET
   @Produces("application/json")
   public List<SalesOrder> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<SalesOrder> findBy(SalesOrderSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<SalesOrder> findByLike(SalesOrderSearchInput searchInput)
   {
      SingularAttribute<SalesOrder, ?>[] attributes = readSeachAttributes(searchInput);
