...
import org.adorsys.adph.server.jpa.SalesMargin_;
import org.adorsys.adph.server.jpa.SalesMarginSearchInput;
import org.adorsys.adph.server.repo.SalesMarginRepository;
...
public class SalesMarginEndpoint
{
   ...
   {
      SalesMargin saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<SalesMargin> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<SalesMargin> findBy(SalesMarginSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<SalesMargin> findByLike(SalesMarginSearchInput searchInput)
   {
      SingularAttribute<SalesMargin, ?>[] attributes = readSeachAttributes(searchInput);
