...
import org.adorsys.adph.server.jpa.CashDrawer_;
import org.adorsys.adph.server.jpa.CashDrawerSearchInput;
import org.adorsys.adph.server.repo.CashDrawerRepository;
...
public class CashDrawerEndpoint
{
   ...
   {
      CashDrawer saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<CashDrawer> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<CashDrawer> findBy(CashDrawerSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<CashDrawer> findByLike(CashDrawerSearchInput searchInput)
   {
      SingularAttribute<CashDrawer, ?>[] attributes = readSeachAttributes(searchInput);
