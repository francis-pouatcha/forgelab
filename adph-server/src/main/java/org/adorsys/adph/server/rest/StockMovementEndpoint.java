...
import org.adorsys.adph.server.jpa.StockMovement_;
import org.adorsys.adph.server.jpa.StockMovementSearchInput;
import org.adorsys.adph.server.repo.StockMovementRepository;
...
public class StockMovementEndpoint
{
   ...
   {
      StockMovement saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<StockMovement> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<StockMovement> findBy(StockMovementSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<StockMovement> findByLike(StockMovementSearchInput searchInput)
   {
      SingularAttribute<StockMovement, ?>[] attributes = readSeachAttributes(searchInput);
