...
import org.adorsys.adph.server.jpa.RoleName_;
import org.adorsys.adph.server.jpa.RoleNameSearchInput;
import org.adorsys.adph.server.repo.RoleNameRepository;
...
public class RoleNameEndpoint
{
   ...
   {
      RoleName saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<RoleName> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<RoleName> findBy(RoleNameSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<RoleName> findByLike(RoleNameSearchInput searchInput)
   {
      SingularAttribute<RoleName, ?>[] attributes = readSeachAttributes(searchInput);
