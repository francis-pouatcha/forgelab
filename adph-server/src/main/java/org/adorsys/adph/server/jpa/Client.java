...
import org.adorsys.adph.server.jpa.ClientType;
import javax.persistence.Enumerated;
import org.hibernate.envers.Audited;
import javax.xml.bind.annotation.XmlRootElement;

@Entity
@Description("org.adorsys.adph.server.jpa.Client.description")
@Audited
@XmlRootElement
public class Client implements Serializable
{
   ...
   @Column
   @Description("org.adorsys.adph.server.jpa.Client.clientNumber.description")
   private String clientNumber;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.name.description")
   private String name;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.firstName.description")
   private String firstName;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.fullName.description")
   private String fullName;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.landLinePhone.description")
   private String landLinePhone;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.mobile.description")
   private String mobile;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.fax.description")
   private String fax;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.email.description")
   private String email;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.creditAuthorized.description")
   private boolean creditAuthorized;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.discountAuthorized.description")
   private boolean discountAuthorized;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.totalCreditLine.description")
   private BigDecimal totalCreditLine;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.employer.description")
   private String employer;

   @Temporal(TemporalType.TIMESTAMP)
   @Description("org.adorsys.adph.server.jpa.Client.birthDate.description")
   private Date birthDate;

   @ManyToOne
   @Description("org.adorsys.adph.server.jpa.Client.gender.description")
   private Gender gender;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.coverageRate.description")
   private BigDecimal coverageRate;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.note.description")
   @Size(max = 256)
   private String note;

   @ManyToOne
   @Description("org.adorsys.adph.server.jpa.Client.payingClient.description")
   private Client payingClient;

   @ManyToOne
   @Description("org.adorsys.adph.server.jpa.Client.clientCategory.description")
   private Client clientCategory;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.totalDebt.description")
   private BigDecimal totalDebt;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.clientType.description")
   @Enumerated
   private ClientType clientType;

   @Column
   @Description("org.adorsys.adph.server.jpa.Client.serialNumber.description")
