...
import org.adorsys.adph.server.jpa.PrescriptionBook_;
import org.adorsys.adph.server.jpa.PrescriptionBookSearchInput;
import org.adorsys.adph.server.repo.PrescriptionBookRepository;
...
public class PrescriptionBookEndpoint
{
   ...
   {
      PrescriptionBook saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<PrescriptionBook> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<PrescriptionBook> findBy(PrescriptionBookSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<PrescriptionBook> findByLike(PrescriptionBookSearchInput searchInput)
   {
      SingularAttribute<PrescriptionBook, ?>[] attributes = readSeachAttributes(searchInput);
