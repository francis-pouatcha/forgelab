...
import org.adorsys.adph.server.jpa.SalesOrderItem_;
import org.adorsys.adph.server.jpa.SalesOrderItemSearchInput;
import org.adorsys.adph.server.repo.SalesOrderItemRepository;
...
public class SalesOrderItemEndpoint
{
   ...
   {
      SalesOrderItem saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<SalesOrderItem> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<SalesOrderItem> findBy(SalesOrderItemSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<SalesOrderItem> findByLike(SalesOrderItemSearchInput searchInput)
   {
      SingularAttribute<SalesOrderItem, ?>[] attributes = readSeachAttributes(searchInput);
