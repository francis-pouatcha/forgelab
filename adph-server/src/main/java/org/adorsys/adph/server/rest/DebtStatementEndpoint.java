...
import org.adorsys.adph.server.jpa.DebtStatement_;
import org.adorsys.adph.server.jpa.DebtStatementSearchInput;
import org.adorsys.adph.server.repo.DebtStatementRepository;
...
public class DebtStatementEndpoint
{
   ...
   {
      DebtStatement saved = repository.save(entity);
      return saved;
   }
   ...
   @GET
   @Produces("application/json")
   public List<DebtStatement> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<DebtStatement> findBy(DebtStatementSearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<DebtStatement> findByLike(DebtStatementSearchInput searchInput)
   {
      SingularAttribute<DebtStatement, ?>[] attributes = readSeachAttributes(searchInput);
