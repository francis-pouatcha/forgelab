...
import org.adorsys.adph.server.jpa.Currency_;
import org.adorsys.adph.server.jpa.CurrencySearchInput;
import org.adorsys.adph.server.repo.CurrencyRepository;
...
public class CurrencyEndpoint
{
   ...
   @GET
   @Produces("application/json")
   public List<Currency> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<Currency> findBy(CurrencySearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<Currency> findByLike(CurrencySearchInput searchInput)
   {
      SingularAttribute<Currency, ?>[] attributes = readSeachAttributes(searchInput);
