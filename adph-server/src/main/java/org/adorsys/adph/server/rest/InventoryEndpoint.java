...
import org.adorsys.adph.server.jpa.Inventory_;
import org.adorsys.adph.server.jpa.InventorySearchInput;
import org.adorsys.adph.server.repo.InventoryRepository;
...
public class InventoryEndpoint
{
   ...
   @GET
   @Produces("application/json")
   public List<Inventory> listAll(@QueryParam("start") int start,
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<Inventory> findBy(InventorySearchInput searchInput)
   {
   ...
   @Produces("application/json")
   @Consumes("application/json")
   public List<Inventory> findByLike(InventorySearchInput searchInput)
   {
      SingularAttribute<Inventory, ?>[] attributes = readSeachAttributes(searchInput);
