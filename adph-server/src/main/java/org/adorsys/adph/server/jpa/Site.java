...
@Entity
@Description("org.adorsys.adph.server.jpa.Site.description")
@Audited
@XmlRootElement
public class Site implements Serializable
{
   ...
   @Column
   @Description("org.adorsys.adph.server.jpa.Site.displayName.description")
   @NotNull
   private String displayName;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.address.description")
   @Size(max = 256)
   private String address;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.city.description")
   private String city;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.country.description")
   private String country;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.siteNumber.description")
   private String siteNumber;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.phone.description")
   private String phone;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.siteManager.description")
   private String siteManager;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.email.description")
   private String email;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.siteInternet.description")
   private String siteInternet;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.mobile.description")
   private String mobile;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.fax.description")
   private String fax;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.registerNumber.description")
   private String registerNumber;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.messageTicker.description")
   private String messageTicker;

   @Column
   @Description("org.adorsys.adph.server.jpa.Site.barCodePerLine.description")
