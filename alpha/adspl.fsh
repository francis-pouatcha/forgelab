...
new-project --named adspl --topLevelPackage org.adorsys.adspl --finalName adspl --projectFolder adspl;
...
field oneToOne --named addressSec --fieldType ~.jpa.Address --cascade ALL;
description add-field-description --onProperty addressSec --title "Address" --text "The address of this person";
description add-field-description --onProperty addressSec --title "Adresse" --text "Adresse de cette personne" --locale fr;
