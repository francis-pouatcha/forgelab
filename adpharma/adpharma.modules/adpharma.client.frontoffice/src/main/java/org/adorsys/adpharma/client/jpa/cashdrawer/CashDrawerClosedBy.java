...
public class CashDrawerClosedBy implements Association<CashDrawer, Login>, Cloneable
{
   ...
   public CashDrawerClosedBy()
   {
   }

   public CashDrawerClosedBy(Login entity)
   {
   ...
   //			return false;
   //		CashDrawerClosedBy other = (CashDrawerClosedBy) obj;
   ...
   {
      CashDrawerClosedBy a = new CashDrawerClosedBy();
      a.id = id;
      a.version = version;
