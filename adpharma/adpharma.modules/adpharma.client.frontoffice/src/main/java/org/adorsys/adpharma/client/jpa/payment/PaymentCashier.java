...
public class PaymentCashier implements Association<Payment, Login>, Cloneable
{
   ...
   public PaymentCashier(Login entity)
   {
   ...
   //			return false;
   //		PaymentCashier other = (PaymentCashier) obj;
   ...
   {
      PaymentCashier a = new PaymentCashier();
      a.id = id;
      a.version = version;
