...
public class WareHouseAgency implements Association<WareHouse, Agency>, Cloneable
{
	  ...
	  private Long id;
	   ...
	   public WareHouseAgency()
	   {
	   }

	   public WareHouseAgency(Agency entity)
	   {
	   ...
	   {
		   WareHouseAgency a = new WareHouseAgency();
	      a.id = id;
	      a.version = version;
