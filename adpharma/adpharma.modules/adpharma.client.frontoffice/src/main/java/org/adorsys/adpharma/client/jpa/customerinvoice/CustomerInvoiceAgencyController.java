...
public abstract class CustomerInvoiceAgencyController
{
   @Inject
   ...
   protected void disableButton(final CustomerInvoiceAgencySelection selection)
   {
      selection.getAgency().setDisable(true);
   }

   protected void activateButton(final CustomerInvoiceAgencySelection selection)
   {
   }
