...
public class WareHouseArticleLotRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<WareHouseArticleLot> removedEvent;

   @Inject
   private WareHouseArticleLotRemoveService removeService;
   @Inject
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent WareHouseArticleLot entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent WareHouseArticleLot entity)
   {
   ...
   public void postConstruct()
   {
      confirmDialog.setText(resourceBundle.getString("Entity_confirm_remove.title")
            + " "
            + resourceBundle.getString("WareHouse_description.title"));
      ...
      removeService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            WareHouseArticleLotRemoveService service = (WareHouseArticleLotRemoveService) wse
                  .getSource();
            WareHouseArticleLot p = service.getValue();
            wse.consume();
            service.reset();
            removedEvent.fire(p);
         }
