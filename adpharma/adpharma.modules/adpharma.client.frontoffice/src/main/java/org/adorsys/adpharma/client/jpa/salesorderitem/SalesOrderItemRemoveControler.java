...
public class SalesOrderItemRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<SalesOrderItem> removedEvent;
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent SalesOrderItem entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent SalesOrderItem entity)
   {
