...
@Singleton
public class PackagingModeSearchController implements EntityController
{

   @Inject
   private PackagingModeSearchView searchView;
   ...
   private Event<PackagingModeSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new PackagingMode(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent PackagingMode templateEntity)
   {
   ...
   private PackagingModeSearchInput buildSearchInputs()
   {
      PackagingModeSearchInput result = new PackagingModeSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent PackagingMode model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent PackagingModeSearchResult searchResult)
   {
