...
public class ProductDetailConfigRemoveControler
{
   ...
   private Event<ProductDetailConfig> removedEvent;

   @Inject
   private ProductDetailConfigRemoveService removeService;
   @Inject
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent ProductDetailConfig entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent ProductDetailConfig entity)
   {
   ...
   public void postConstruct()
   {
      confirmDialog.setText(resourceBundle.getString("Entity_confirm_remove.title")
            + " "
            + resourceBundle.getString("ProductDetailConfig_description.title"));
      ...
      removeService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            ProductDetailConfigRemoveService service = (ProductDetailConfigRemoveService) wse
                  .getSource();
            ProductDetailConfig p = service.getValue();
            wse.consume();
            service.reset();
            removedEvent.fire(p);
         }
