...
@Singleton
public class CustomerCategorySearchController implements EntityController
{

   @Inject
   private CustomerCategorySearchView searchView;
   ...
   private Event<CustomerCategorySearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent CustomerCategory templateEntity)
   {
   ...
   private CustomerCategorySearchInput buildSearchInputs()
   {
      CustomerCategorySearchInput result = new CustomerCategorySearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent CustomerCategory model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CustomerCategorySearchResult searchResult)
   {
