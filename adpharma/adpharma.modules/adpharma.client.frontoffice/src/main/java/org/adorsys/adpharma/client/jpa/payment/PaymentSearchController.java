...
@Singleton
public class PaymentSearchController implements EntityController
{

   @Inject
   private PaymentSearchView searchView;
   ...
   private Event<PaymentSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Payment templateEntity)
   {
   ...
   private PaymentSearchInput buildSearchInputs()
   {
      PaymentSearchInput result = new PaymentSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Payment model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent PaymentSearchResult searchResult)
   {
