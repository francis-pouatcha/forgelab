...
@Singleton
public class SalesOrderItemController extends DomainComponentController
{

   @Inject
   private SalesOrderItemSearchController searchController;

   @Inject
   private SalesOrderItemCreateController createController;

   @Inject
   private SalesOrderItemEditController editController;

   @Inject
   private SalesOrderItemListController listController;

   @Inject
   private SalesOrderItemDisplayController displayController;

   @Inject
   private SalesOrderItemIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<SalesOrderItem> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<SalesOrderItem> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<SalesOrderItem> selectedModelEvent;

   private SalesOrderItem createModel = new SalesOrderItem();
   private SalesOrderItem searchModel = new SalesOrderItem();
   private SalesOrderItem selectedModel = new SalesOrderItem();
    ...
    * @param entities
    */
   public void handleSearchResult(@Observes @EntitySearchDoneEvent List<SalesOrderItem> entities)
   {
   ...
   public void handleSelectionEvent(@Observes @EntitySelectionEvent SalesOrderItem selectedEntity)
   {
      if (!registration.canRead())
         return;
      // if result is empty: display no result.
      // else display list of salesOrderItems.
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent SalesOrderItem selectedEntity)
   {
      if (!registration.canRead())
         return;
      List<EntityController> displayedViews = getDisplayedViews();
   ...
   /**
    * Display search form.
    * @param selectedSalesOrderItem
    */
   public void handleCreateRequestedEvent(@Observes @EntityCreateRequestedEvent SalesOrderItem templateEntity)
   {
   ...
   public void handleEditRequestedEvent(@Observes @EntityEditRequestedEvent SalesOrderItem selectedEntity)
   {
   ...
   public void handleEditCanceledEvent(@Observes @EntityEditCanceledEvent SalesOrderItem selectedEntity)
   {
      List<EntityController> displayedViews = getDisplayedViews();
      displayedViews.clear();
      displayedViews.add(listController);
   ...
   public void handleEditDoneEvent(@Observes @EntityEditDoneEvent SalesOrderItem selectedEntity)
   {
      List<EntityController> displayedViews = getDisplayedViews();
      displayedViews.clear();
      displayedViews.add(listController);
