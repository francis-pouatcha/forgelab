...
public class EmployerCreatingUser implements Association<Employer, Login>, Cloneable
{
   ...
   public EmployerCreatingUser()
   {
   }

   public EmployerCreatingUser(Login entity)
   {
   ...
   //			return false;
   //		EmployerCreatingUser other = (EmployerCreatingUser) obj;
   ...
   {
      EmployerCreatingUser a = new EmployerCreatingUser();
      a.id = id;
      a.version = version;
