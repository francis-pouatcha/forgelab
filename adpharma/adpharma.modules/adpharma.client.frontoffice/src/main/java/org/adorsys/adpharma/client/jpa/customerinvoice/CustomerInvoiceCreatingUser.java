...
public class CustomerInvoiceCreatingUser implements Association<CustomerInvoice, Login>, Cloneable
{
   ...
   public CustomerInvoiceCreatingUser()
   {
   }

   public CustomerInvoiceCreatingUser(Login entity)
   {
   ...
   //			return false;
   //		CustomerInvoiceCreatingUser other = (CustomerInvoiceCreatingUser) obj;
   ...
   {
      CustomerInvoiceCreatingUser a = new CustomerInvoiceCreatingUser();
      a.id = id;
      a.version = version;
