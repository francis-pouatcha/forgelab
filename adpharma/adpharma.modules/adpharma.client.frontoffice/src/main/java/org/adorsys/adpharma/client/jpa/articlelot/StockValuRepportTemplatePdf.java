...
public class StockValuRepportTemplatePdf {
	...
	private void fillTableHaeder() throws DocumentException {
		...
		PdfPCell pdfPCell = new PdfPCell();
		pdfPCell.addElement(new StandardText(resourceBundle.getString("StockValuRepportTemplatePdf_pic.title")));
		reportTable.addCell(pdfPCell);

		pdfPCell = new PdfPCell();
		pdfPCell.addElement(new StandardText(resourceBundle.getString("StockValuRepportTemplatePdf_articleName.title")));
		reportTable.addCell(pdfPCell);


		pdfPCell = new PdfPCell();
		pdfPCell.addElement(new StandardText(resourceBundle.getString("StockValuRepportTemplatePdf_qtyOrdered.title")));
		reportTable.addCell(pdfPCell);
		
		pdfPCell = new PdfPCell();
		pdfPCell.addElement(new StandardText(resourceBundle.getString("StockValuRepportTemplatePdf_stockQuantity.title")));
		reportTable.addCell(pdfPCell);

		pdfPCell = new PdfPCell();
		pdfPCell.addElement(new StandardText(resourceBundle.getString("StockValuRepportTemplatePdf_purchasePricePU.title")));
		reportTable.addCell(pdfPCell);

		pdfPCell = new PdfPCell();
		pdfPCell.addElement(new StandardText(resourceBundle.getString("StockValuRepportTemplatePdf_totalPurchasePrice.title")));
		reportTable.addCell(pdfPCell);
	...
	private void printReportHeader() throws DocumentException {
		...
		Paragraph paragraph = new Paragraph(new BoldText(resourceBundle.getString("StockValuRepportTemplatePdf_header.title")));
