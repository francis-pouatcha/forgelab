...
public class WareHouseRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<WareHouse> removedEvent;

   @Inject
   private WareHouseRemoveService removeService;
   @Inject
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent WareHouse entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent WareHouse entity)
   {
   ...
   public void postConstruct()
   {
      ...
      removeService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            WareHouseRemoveService service = (WareHouseRemoveService) wse
                  .getSource();
            WareHouse p = service.getValue();
            wse.consume();
            service.reset();
            removedEvent.fire(p);
         }
