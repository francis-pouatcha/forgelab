...
@Singleton
public class InsurranceSearchController implements EntityController
{

   @Inject
   private InsurranceSearchView searchView;
   ...
   private Event<InsurranceSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            InsurranceSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Insurrance(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Insurrance templateEntity)
   {
   ...
   private InsurranceSearchInput buildSearchInputs()
   {
      InsurranceSearchInput result = new InsurranceSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Insurrance model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent InsurranceSearchResult searchResult)
   {
