...
@Singleton
public class ClearanceConfigSearchController implements EntityController
{

   @Inject
   private ClearanceConfigSearchView searchView;
   ...
   private Event<ClearanceConfigSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent ClearanceConfig templateEntity)
   {
   ...
   private ClearanceConfigSearchInput buildSearchInputs()
   {
      ClearanceConfigSearchInput result = new ClearanceConfigSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent ClearanceConfig model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent ClearanceConfigSearchResult searchResult)
   {
