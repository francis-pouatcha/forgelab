...
public class DisbursementCashier implements Association<Disbursement, Login>, Cloneable{
	 private Long id;
	   private int version;
	   ...
	   public DisbursementCashier()
	   {
	   }

	   public DisbursementCashier(Login entity)
	   {
	   ...
	   //			return false;
	   //		CashDrawerCashier other = (CashDrawerCashier) obj;
	   ...
	   {
		   DisbursementCashier a = new DisbursementCashier();
	      a.id = id;
	      a.version = version;
