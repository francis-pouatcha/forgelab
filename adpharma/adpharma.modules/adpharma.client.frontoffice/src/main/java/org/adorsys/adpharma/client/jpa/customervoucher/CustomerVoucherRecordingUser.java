...
public class CustomerVoucherRecordingUser implements Association<CustomerVoucher, Login>, Cloneable
{
   ...
   public CustomerVoucherRecordingUser(Login entity)
   {
   ...
   //			return false;
   //		CustomerVoucherRecordingUser other = (CustomerVoucherRecordingUser) obj;
   ...
   {
      CustomerVoucherRecordingUser a = new CustomerVoucherRecordingUser();
      a.id = id;
      a.version = version;
