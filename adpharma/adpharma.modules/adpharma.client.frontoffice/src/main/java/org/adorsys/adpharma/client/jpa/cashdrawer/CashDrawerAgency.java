...
public class CashDrawerAgency implements Association<CashDrawer, Agency>, Cloneable
{
   ...
   public CashDrawerAgency()
   {
   }

   public CashDrawerAgency(Agency entity)
   {
   ...
   {
      CashDrawerAgency a = new CashDrawerAgency();
      a.id = id;
      a.version = version;
