...
public class SalesOrderItemVat implements Association<SalesOrderItem, VAT>, Cloneable
{
   ...
   public SalesOrderItemVat()
   {
   }

   public SalesOrderItemVat(VAT entity)
   {
   ...
   //			return false;
   //		SalesOrderItemVat other = (SalesOrderItemVat) obj;
   ...
   {
      SalesOrderItemVat a = new SalesOrderItemVat();
      a.id = id;
      a.version = version;
