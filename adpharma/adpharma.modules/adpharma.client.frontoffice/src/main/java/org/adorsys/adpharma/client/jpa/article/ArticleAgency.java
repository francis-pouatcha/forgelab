...
public class ArticleAgency implements Association<Article, Agency>, Cloneable
{
   ...
   public ArticleAgency()
   {
   }

   public ArticleAgency(Agency entity)
   {
   ...
   {
      ArticleAgency a = new ArticleAgency();
      a.id = id;
      a.version = version;
