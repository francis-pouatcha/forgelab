...
public abstract class ArticleAgencyController
{
   @Inject
   ...
   protected void disableButton(final ArticleAgencySelection selection)
   {
      selection.getAgency().setDisable(true);
   }

   protected void activateButton(final ArticleAgencySelection selection)
   {
   }
