...
public class SupplierInvoiceItemArticle implements Association<SupplierInvoiceItem, Article>, Cloneable
{
   ...
   public SupplierInvoiceItemArticle()
   {
   }

   public SupplierInvoiceItemArticle(Article entity)
   {
   ...
   //			return false;
   //		SupplierInvoiceItemArticle other = (SupplierInvoiceItemArticle) obj;
   ...
   {
      SupplierInvoiceItemArticle a = new SupplierInvoiceItemArticle();
      a.id = id;
      a.version = version;
