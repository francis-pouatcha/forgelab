...
public class SupplierInvoiceItemArticleForm extends AbstractToOneAssociation<SupplierInvoiceItem, Article>
{
   ...
   public void update(SupplierInvoiceItemArticle data)
   {
