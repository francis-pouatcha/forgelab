...
public class DebtStatementCustomerInvoiceAssocSearchInput
{
   ...
   public DebtStatementCustomerInvoiceAssoc getEntity()
   {
      return entity;
   }

   public void setEntity(DebtStatementCustomerInvoiceAssoc entity)
   {
      this.entity = entity;
   }
