...
public class DeliveryItemRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<DeliveryItem> removedEvent;
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent DeliveryItem entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent DeliveryItem entity)
   {
