...
public class DocumentArchiveRecordingUserForm extends AbstractToOneAssociation<DocumentArchive, Login>
{
   ...
   public void update(DocumentArchiveRecordingUser data)
   {
