...
public class ArticleEquivalenceView extends AbstractForm<ArticleEquivalence>
{
   ...
   public Set<ConstraintViolation<ArticleEquivalence>> validate(ArticleEquivalence model)
   {
      ...
      violations.addAll(toOneAggreggationFieldValidator.validate(articleEquivalenceMainArticleSelection.getMainArticle(), model.getMainArticle(), ArticleEquivalence.class, "mainArticle", resourceBundle));
      violations.addAll(toOneAggreggationFieldValidator.validate(articleEquivalenceEquivalentArticleSelection.getEquivalentArticle(), model.getEquivalentArticle(), ArticleEquivalence.class, "equivalentArticle", resourceBundle));
      return violations;
   }
