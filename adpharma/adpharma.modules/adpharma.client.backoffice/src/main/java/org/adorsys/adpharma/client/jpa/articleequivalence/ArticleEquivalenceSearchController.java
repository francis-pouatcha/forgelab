...
@Singleton
public class ArticleEquivalenceSearchController implements EntityController
{

   @Inject
   private ArticleEquivalenceSearchView searchView;

   @Inject
   private ArticleEquivalenceSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<ArticleEquivalenceSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            ArticleEquivalenceSearchService s = (ArticleEquivalenceSearchService) event.getSource();
            ArticleEquivalenceSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent ArticleEquivalence templateEntity)
   {
   ...
   private ArticleEquivalenceSearchInput buildSearchInputs()
   {
      ArticleEquivalenceSearchInput result = new ArticleEquivalenceSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent ArticleEquivalence model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent ArticleEquivalenceSearchResult searchResult)
   {
