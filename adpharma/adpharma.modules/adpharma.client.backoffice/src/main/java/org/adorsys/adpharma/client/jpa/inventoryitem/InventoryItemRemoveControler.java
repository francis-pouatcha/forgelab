...
public class InventoryItemRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<InventoryItem> removedEvent;
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent InventoryItem entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent InventoryItem entity)
   {
