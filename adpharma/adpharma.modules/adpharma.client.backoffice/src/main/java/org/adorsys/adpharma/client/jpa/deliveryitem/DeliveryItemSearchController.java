...
@Singleton
public class DeliveryItemSearchController implements EntityController
{

   @Inject
   private DeliveryItemSearchView searchView;
   ...
   private Event<DeliveryItemSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new DeliveryItem(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent DeliveryItem templateEntity)
   {
   ...
   private DeliveryItemSearchInput buildSearchInputs()
   {
      DeliveryItemSearchInput result = new DeliveryItemSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent DeliveryItem model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent DeliveryItemSearchResult searchResult)
   {
