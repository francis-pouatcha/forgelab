...
@Singleton
public class InventoryItemSearchController implements EntityController
{

   @Inject
   private InventoryItemSearchView searchView;
   ...
   private Event<InventoryItemSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            InventoryItemSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new InventoryItem(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent InventoryItem templateEntity)
   {
   ...
   private InventoryItemSearchInput buildSearchInputs()
   {
      InventoryItemSearchInput result = new InventoryItemSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent InventoryItem model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent InventoryItemSearchResult searchResult)
   {
