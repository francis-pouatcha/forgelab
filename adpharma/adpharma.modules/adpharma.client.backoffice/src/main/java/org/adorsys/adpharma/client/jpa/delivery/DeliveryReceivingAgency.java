...
public class DeliveryReceivingAgency implements Association<Delivery, Agency>, Cloneable
{
   ...
   public DeliveryReceivingAgency()
   {
   }

   public DeliveryReceivingAgency(Agency entity)
   {
   ...
   //			return false;
   //		DeliveryReceivingAgency other = (DeliveryReceivingAgency) obj;
   ...
   {
      DeliveryReceivingAgency a = new DeliveryReceivingAgency();
      a.id = id;
      a.version = version;
