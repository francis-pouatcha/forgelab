...
@Singleton
public class ProcurementOrderSearchController implements EntityController
{

   @Inject
   private ProcurementOrderSearchView searchView;
   ...
   private Event<ProcurementOrderSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            ProcurementOrderSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new ProcurementOrder(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent ProcurementOrder templateEntity)
   {
   ...
   private ProcurementOrderSearchInput buildSearchInputs()
   {
      ProcurementOrderSearchInput result = new ProcurementOrderSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent ProcurementOrder model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent ProcurementOrderSearchResult searchResult)
   {
