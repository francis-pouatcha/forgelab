...
public class PhmlOrderBuilder {
	...
	public void build(ProcurementOrder order) throws IOException{
		String messageDir = applicationConfiguration.getConfiguration().getProperty("phml_messages_directory.config");
		String repartiteur = applicationConfiguration.getConfiguration().getProperty("phml_repartiter.config");
