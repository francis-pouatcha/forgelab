...
public class StockMovement implements Serializable
{
	...
	public Boolean isSaleStockMovement(){
		return StockMovementTerminal.WAREHOUSE.equals(movementOrigin)
				&& StockMovementTerminal.CUSTOMER.equals(movementDestination)
				&& StockMovementType.OUT.equals(movementType);
	}
	
	public Boolean isReturnStockMovement(){
		return StockMovementTerminal.CUSTOMER.equals(movementOrigin)
				&& StockMovementTerminal.WAREHOUSE.equals(movementDestination)
				&& StockMovementType.IN.equals(movementType);
	}
	
	public Boolean isTrashedStockMovement(){
		return StockMovementTerminal.WAREHOUSE.equals(movementOrigin)
				&& StockMovementTerminal.TRASH.equals(movementDestination)
				&& StockMovementType.OUT.equals(movementType);
	}
	
	public Boolean canEnablePurchase(){
		return isSaleStockMovement() || isReturnStockMovement() || isTrashedStockMovement();
	}
