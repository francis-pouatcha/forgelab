...
public class CashDrawerCashier implements Association<CashDrawer, Login>, Cloneable
{
   ...
   public CashDrawerCashier()
   {
   }

   public CashDrawerCashier(Login entity)
   {
   ...
   {
      CashDrawerCashier a = new CashDrawerCashier();
      a.id = id;
      a.version = version;
