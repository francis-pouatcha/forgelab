...
//@Eager
@Singleton
public class DocumentArchiveRegistration extends DomainComponentRegistration
{

   @Inject
   @Bundle(DocumentArchive.class)
   private ResourceBundle resourceBundle;

   @Override
   protected Class<?> getComponentClass()
   {
      return DocumentArchive.class;
   }

   @Override
   protected Class<? extends DomainComponentController> getControllerClass()
   {
      return DocumentArchiveController.class;
   }

   @Override
   protected String getComponentI18nName()
   {
      Description annotation = DocumentArchive.class.getAnnotation(Description.class);
      if (annotation != null)
         return resourceBundle.getString(annotation.value() + ".title");
      return DocumentArchive.class.getName();
   }

   @Override
   public String getComponentPermission()
   {
      return "org.adorsys.adpharma.server.jpa.DocumentArchive";
   }
