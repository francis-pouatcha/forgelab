...
public class SalesOrderReturnService extends Service<SalesOrder>
{
	   ...
	   public SalesOrderReturnService setEntity(SalesOrder entity)
	   {
	      this.entity = entity;
	      return this;
	   }
	   ...
	   protected Task<SalesOrder> createTask()
	   {
	      return new Task<SalesOrder>()
	      {
	         ...
	         {
	            return remoteService.processReturn(entity);
	         }
	      };
	   }
