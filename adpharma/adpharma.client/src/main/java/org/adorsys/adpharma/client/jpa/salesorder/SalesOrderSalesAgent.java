...
public class SalesOrderSalesAgent implements Association<SalesOrder, Login>, Cloneable
{
   ...
   public SalesOrderSalesAgent()
   {
   }

   public SalesOrderSalesAgent(Login entity)
   {
   ...
   //			return false;
   //		SalesOrderSalesAgent other = (SalesOrderSalesAgent) obj;
   ...
   {
      SalesOrderSalesAgent a = new SalesOrderSalesAgent();
      a.id = id;
      a.version = version;
