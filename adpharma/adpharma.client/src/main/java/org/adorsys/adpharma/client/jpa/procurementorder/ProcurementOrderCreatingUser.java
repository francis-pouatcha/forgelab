...
public class ProcurementOrderCreatingUser implements Association<ProcurementOrder, Login>, Cloneable
{
   ...
   public ProcurementOrderCreatingUser()
   {
   }

   public ProcurementOrderCreatingUser(Login entity)
   {
   ...
   //			return false;
   //		ProcurementOrderCreatingUser other = (ProcurementOrderCreatingUser) obj;
   ...
   {
      ProcurementOrderCreatingUser a = new ProcurementOrderCreatingUser();
      a.id = id;
      a.version = version;
