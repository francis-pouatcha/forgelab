...
public class PaymentPaidBy implements Association<Payment, Customer>, Cloneable
{
   ...
   public PaymentPaidBy()
   {
   }

   public PaymentPaidBy(Customer entity)
   {
   ...
   //			return false;
   //		PaymentPaidBy other = (PaymentPaidBy) obj;
   ...
   {
      PaymentPaidBy a = new PaymentPaidBy();
      a.id = id;
      a.version = version;
