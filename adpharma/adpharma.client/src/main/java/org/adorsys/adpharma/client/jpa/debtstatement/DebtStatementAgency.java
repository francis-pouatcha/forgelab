...
public class DebtStatementAgency implements Association<DebtStatement, Agency>, Cloneable
{
   ...
   public DebtStatementAgency()
   {
   }

   public DebtStatementAgency(Agency entity)
   {
   ...
   //			return false;
   //		DebtStatementAgency other = (DebtStatementAgency) obj;
   ...
   {
      DebtStatementAgency a = new DebtStatementAgency();
      a.id = id;
      a.version = version;
