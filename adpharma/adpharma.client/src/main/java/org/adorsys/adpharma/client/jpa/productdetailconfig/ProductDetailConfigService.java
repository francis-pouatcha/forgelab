...
public class ProductDetailConfigService
{
   ...
   public ProductDetailConfigService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/productdetailconfigs");
   }
   ...
   {//@PathParam("id")
      // TODO encode id
      return target.path("" + id).request(media).delete(ProductDetailConfig.class);
   }
   ...
   public ProductDetailConfig update(ProductDetailConfig entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, ProductDetailConfig.class);
   }
   ...
   {// @PathParam("id") 
      return target.path("" + id).request(media).get(ProductDetailConfig.class);
   }
   ...
   {
      return target.request(media).get(ProductDetailConfigSearchResult.class);
   }
...
//	@Produces({ "application/json", "application/xml" })
   ...
   {
      Entity<ProductDetailConfigSearchInput> searchInputEntity = Entity.entity(
            searchInput, media);
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, ProductDetailConfigSearchResult.class);
   }
