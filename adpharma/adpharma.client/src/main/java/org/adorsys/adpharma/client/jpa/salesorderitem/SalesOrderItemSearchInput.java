...
public class SalesOrderItemSearchInput
{

   /**
    * The entity holding search inputs.
    */
   private SalesOrderItem entity = new SalesOrderItem();
   ...
   public SalesOrderItem getEntity()
   {
      return entity;
   }

   public void setEntity(SalesOrderItem entity)
   {
      this.entity = entity;
   }
