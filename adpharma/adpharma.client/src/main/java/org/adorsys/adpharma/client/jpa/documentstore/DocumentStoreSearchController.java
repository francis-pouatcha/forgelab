...
@Singleton
public class DocumentStoreSearchController implements EntityController
{

   @Inject
   private DocumentStoreSearchView searchView;

   @Inject
   private DocumentStoreSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<DocumentStoreSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            DocumentStoreSearchService s = (DocumentStoreSearchService) event.getSource();
            DocumentStoreSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent DocumentStore templateEntity)
   {
   ...
   private DocumentStoreSearchInput buildSearchInputs()
   {
      DocumentStoreSearchInput result = new DocumentStoreSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent DocumentStore model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent DocumentStoreSearchResult searchResult)
   {
