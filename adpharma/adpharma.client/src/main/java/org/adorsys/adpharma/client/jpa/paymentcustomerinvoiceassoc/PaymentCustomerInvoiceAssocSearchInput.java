...
public class PaymentCustomerInvoiceAssocSearchInput
{

   /**
    * The entity holding search inputs.
    */
   private PaymentCustomerInvoiceAssoc entity = new PaymentCustomerInvoiceAssoc();
   ...
   public PaymentCustomerInvoiceAssoc getEntity()
   {
      return entity;
   }

   public void setEntity(PaymentCustomerInvoiceAssoc entity)
   {
      this.entity = entity;
   }
