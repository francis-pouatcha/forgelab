...
public class LoginAgency implements Association<Login, Agency>, Cloneable
{
   ...
   public LoginAgency(Agency entity)
   {
   ...
   //			return false;
   //		LoginAgency other = (LoginAgency) obj;
