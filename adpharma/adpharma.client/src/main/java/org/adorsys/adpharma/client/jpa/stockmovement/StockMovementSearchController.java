...
@Singleton
public class StockMovementSearchController implements EntityController
{

   @Inject
   private StockMovementSearchView searchView;
   ...
   private Event<StockMovementSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            StockMovementSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new StockMovement(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent StockMovement templateEntity)
   {
   ...
   private StockMovementSearchInput buildSearchInputs()
   {
      StockMovementSearchInput result = new StockMovementSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent StockMovement model)
   {
      this.model = model;
