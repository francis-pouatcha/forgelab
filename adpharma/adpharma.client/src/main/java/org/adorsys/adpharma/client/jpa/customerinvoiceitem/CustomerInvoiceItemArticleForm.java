...
public class CustomerInvoiceItemArticleForm extends AbstractToOneAssociation<CustomerInvoiceItem, Article>
{
   ...
   public void update(CustomerInvoiceItemArticle data)
   {
