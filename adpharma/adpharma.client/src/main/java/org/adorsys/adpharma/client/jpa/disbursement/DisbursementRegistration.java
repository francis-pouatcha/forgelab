...
@Eager
@Singleton
public class DisbursementRegistration extends DomainComponentRegistration
{

	   @Inject
	   @Bundle(Disbursement.class)
	   ...
	   {
	      return DisbursementController.class;
	   }

	   @Override
	   protected String getComponentI18nName()
	   {
	      Description annotation = Disbursement.class.getAnnotation(Description.class);
	      if (annotation != null)
	         return resourceBundle.getString(annotation.value() + ".title");
	      return Disbursement.class.getName();
	   }
