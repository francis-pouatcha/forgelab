...
public class CustomerInvoiceRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<CustomerInvoice> removedEvent;

   @Inject
   private CustomerInvoiceRemoveService removeService;
   @Inject
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent CustomerInvoice entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent CustomerInvoice entity)
   {
   ...
   public void postConstruct()
   {
      ...
      removeService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            CustomerInvoiceRemoveService service = (CustomerInvoiceRemoveService) wse
                  .getSource();
            CustomerInvoice p = service.getValue();
            wse.consume();
            service.reset();
            removedEvent.fire(p);
         }
