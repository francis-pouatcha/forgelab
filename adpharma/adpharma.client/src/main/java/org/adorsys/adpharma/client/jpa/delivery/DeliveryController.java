...
public class DeliveryController extends DomainComponentController
{
	...
	public void handleCreateDoneEvent(@Observes @EntityCreateDoneEvent Delivery selectedEntity)
	{
		List<EntityController> displayedViews = getDisplayedViews();
		displayedViews.clear();
		//		 displayedViews.add(listController);
	...
	public void handleRemoveDoneEvent(@Observes @EntityRemoveDoneEvent Delivery selectedEntity)
	{
		List<EntityController> displayedViews = getDisplayedViews();
		displayedViews.clear();
		displayedViews.add(listController);
