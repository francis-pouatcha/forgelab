...
@Singleton
public class ClearanceConfigController extends DomainComponentController
{

   @Inject
   private ClearanceConfigSearchController searchController;

   @Inject
   private ClearanceConfigCreateController createController;

   @Inject
   private ClearanceConfigEditController editController;

   @Inject
   private ClearanceConfigListController listController;

   @Inject
   private ClearanceConfigDisplayController displayController;

   @Inject
   private ClearanceConfigIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<ClearanceConfig> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<ClearanceConfig> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<ClearanceConfig> selectedModelEvent;

   private ClearanceConfig createModel = new ClearanceConfig();
