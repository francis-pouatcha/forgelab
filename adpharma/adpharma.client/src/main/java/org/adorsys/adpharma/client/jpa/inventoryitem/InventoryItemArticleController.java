...
public abstract class InventoryItemArticleController
{
   ...
   private Event<InventoryItemArticleSelectionEventData> selectionRequestEvent;

   private InventoryItemArticleSelectionEventData pendingSelectionRequest;
   ...
   protected void disableButton(final InventoryItemArticleSelection selection, final InventoryItemArticleForm form)
   {
      selection.getSelectButton().setDisable(true);
   }

   protected void activateButton(final InventoryItemArticleSelection selection, final InventoryItemArticleForm form)
   {
   }

   protected void bind(final InventoryItemArticleSelection selection, final InventoryItemArticleForm form)
   {
      selection.getSelectButton().setOnAction(
            new EventHandler<ActionEvent>()
            {
               ...
               {
                  pendingSelectionRequest = new InventoryItemArticleSelectionEventData(
      ...
      loadService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            event.consume();
            s.reset();
            sourceEntity.setArticle(new InventoryItemArticle(entity));
         }
      });
   ...
   public void handleAssocSelectionResponseEvent(@Observes @AssocSelectionResponseEvent InventoryItemArticleSelectionEventData eventData)
   {
            ...
            && eventData.getSourceEntity() == sourceEntity && eventData.getTargetEntity() != null)
      {
         if (sourceEntity != null)
            sourceEntity.setArticle(new InventoryItemArticle(eventData.getTargetEntity()));
      }
