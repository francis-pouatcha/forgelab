...
public class StockMovementArticle implements Association<StockMovement, Article>, Cloneable
{
   ...
   public StockMovementArticle()
   {
   }

   public StockMovementArticle(Article entity)
   {
   ...
   //			return false;
   //		StockMovementArticle other = (StockMovementArticle) obj;
   ...
   {
      StockMovementArticle a = new StockMovementArticle();
      a.id = id;
      a.version = version;
