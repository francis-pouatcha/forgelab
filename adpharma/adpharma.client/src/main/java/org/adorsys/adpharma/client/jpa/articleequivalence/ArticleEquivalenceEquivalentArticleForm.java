...
public class ArticleEquivalenceEquivalentArticleForm extends AbstractToOneAssociation<ArticleEquivalence, Article>
{
   ...
   {
      articleName.textProperty().bindBidirectional(model.getEquivalentArticle().articleNameProperty());
      pic.textProperty().bindBidirectional(model.getEquivalentArticle().picProperty());
      manufacturer.textProperty().bindBidirectional(model.getEquivalentArticle().manufacturerProperty());
      active.textProperty().bindBidirectional(model.getEquivalentArticle().activeProperty(), new BooleanStringConverter());
      authorizedSale.textProperty().bindBidirectional(model.getEquivalentArticle().authorizedSaleProperty(), new BooleanStringConverter());
      qtyInStock.numberProperty().bindBidirectional(model.getEquivalentArticle().qtyInStockProperty());
      sppu.numberProperty().bindBidirectional(model.getEquivalentArticle().sppuProperty());
   }

   public void update(ArticleEquivalenceEquivalentArticle data)
   {
