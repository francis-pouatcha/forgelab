...
public class CustomerInvoiceService
{
   ...
   public CustomerInvoiceService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/customerinvoices");
   }
   ...
   {//@PathParam("id")
      // TODO encode id
      return target.path("" + id).request(media).delete(CustomerInvoice.class);
   }
   ...
   public CustomerInvoice update(CustomerInvoice entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, CustomerInvoice.class);
   }
   ...
   public CustomerInvoiceSearchResult findBy(CustomerInvoiceSearchInput searchInput)
   {
      ...
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, CustomerInvoiceSearchResult.class);
   }
