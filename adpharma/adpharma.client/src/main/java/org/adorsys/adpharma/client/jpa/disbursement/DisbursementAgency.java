...
public class DisbursementAgency implements Association<Disbursement, Agency>, Cloneable {
	 private Long id;
	   private int version;
	   ...
	   public DisbursementAgency()
	   {
	   }

	   public DisbursementAgency(Agency entity)
	   {
	   ...
	   //			return false;
	   //		CashDrawerAgency other = (CashDrawerAgency) obj;
	   ...
	   {
		   DisbursementAgency a = new DisbursementAgency();
	      a.id = id;
	      a.version = version;
