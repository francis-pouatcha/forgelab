...
public class DeliveryItemCreatingUser implements Association<DeliveryItem, Login>, Cloneable
{
   ...
   public DeliveryItemCreatingUser()
   {
   }

   public DeliveryItemCreatingUser(Login entity)
   {
   ...
   //			return false;
   //		DeliveryItemCreatingUser other = (DeliveryItemCreatingUser) obj;
   ...
   {
      DeliveryItemCreatingUser a = new DeliveryItemCreatingUser();
      a.id = id;
      a.version = version;
