...
public abstract class ArticleEquivalenceMainArticleController
{
   ...
   private Event<ArticleEquivalenceMainArticleSelectionEventData> selectionRequestEvent;

   private ArticleEquivalenceMainArticleSelectionEventData pendingSelectionRequest;
   ...
   protected void disableButton(final ArticleEquivalenceMainArticleSelection selection, final ArticleEquivalenceMainArticleForm form)
   {
      selection.getSelectButton().setDisable(true);
   }

   protected void activateButton(final ArticleEquivalenceMainArticleSelection selection, final ArticleEquivalenceMainArticleForm form)
   {
   }

   protected void bind(final ArticleEquivalenceMainArticleSelection selection, final ArticleEquivalenceMainArticleForm form)
   {
      selection.getSelectButton().setOnAction(
            new EventHandler<ActionEvent>()
            {
               ...
               {
                  pendingSelectionRequest = new ArticleEquivalenceMainArticleSelectionEventData(
      ...
      loadService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            event.consume();
            s.reset();
            sourceEntity.setMainArticle(new ArticleEquivalenceMainArticle(entity));
         }
      });
   ...
   public void handleAssocSelectionResponseEvent(@Observes @AssocSelectionResponseEvent ArticleEquivalenceMainArticleSelectionEventData eventData)
   {
            ...
            && eventData.getSourceEntity() == sourceEntity && eventData.getTargetEntity() != null)
      {
         if (sourceEntity != null)
            sourceEntity.setMainArticle(new ArticleEquivalenceMainArticle(eventData.getTargetEntity()));
      }
