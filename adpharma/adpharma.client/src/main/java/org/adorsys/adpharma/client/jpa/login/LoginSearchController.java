...
@Singleton
public class LoginSearchController implements EntityController
{

   @Inject
   private LoginSearchView searchView;
   ...
   private Event<LoginSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            LoginSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Login(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Login templateEntity)
   {
   ...
   private LoginSearchInput buildSearchInputs()
   {
      LoginSearchInput result = new LoginSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Login model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent LoginSearchResult searchResult)
   {
