...
public class DocumentArchiveSearchController implements EntityController
{
   ...
   @Inject
   private DocumentArchiveSearchView searchView;

   @Inject
   private DocumentArchiveSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<DocumentArchiveSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            DocumentArchiveSearchService s = (DocumentArchiveSearchService) event.getSource();
            DocumentArchiveSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent DocumentArchive templateEntity)
   {
   ...
   private DocumentArchiveSearchInput buildSearchInputs()
   {
      DocumentArchiveSearchInput result = new DocumentArchiveSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent DocumentArchive model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent DocumentArchiveSearchResult searchResult)
   {
