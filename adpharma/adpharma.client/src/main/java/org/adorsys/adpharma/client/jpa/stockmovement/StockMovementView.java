...
public class StockMovementView extends AbstractForm<StockMovement>
{
   ...
   public Set<ConstraintViolation<StockMovement>> validate(StockMovement model)
   {
      ...
      violations.addAll(toOneAggreggationFieldValidator.validate(stockMovementAgencySelection.getAgency(), model.getAgency(), StockMovement.class, "agency", resourceBundle));
      return violations;
   }
