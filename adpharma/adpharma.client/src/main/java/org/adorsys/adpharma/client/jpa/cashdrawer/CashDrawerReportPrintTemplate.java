...
public class CashDrawerReportPrintTemplate {
	...
	public CashDrawerReportPrintTemplate(CashDrawerReportPrinterData cashDrawerPrinterData, ResourceBundle resourceBundle,
			Locale locale) {
