...
@Singleton
public class InventorySearchController implements EntityController
{

   @Inject
   private InventorySearchView searchView;
   ...
   private Event<InventorySearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            InventorySearchService s = (InventorySearchService) event.getSource();
            InventorySearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Inventory templateEntity)
   {
   ...
   private InventorySearchInput buildSearchInputs()
   {
      InventorySearchInput result = new InventorySearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Inventory model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent InventorySearchResult searchResult)
   {
