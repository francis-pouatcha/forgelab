...
@RelationshipTable
public class DebtStatementCustomerInvoiceAssoc
{
   ...
   @NotNull
   private SimpleObjectProperty<DebtStatement> source;
   @NotNull
   ...
   public SimpleObjectProperty<DebtStatement> sourceProperty()
   {
      if (source == null)
      {
         source = new SimpleObjectProperty<DebtStatement>(new DebtStatement());
      }
      return source;
   }

   @NotNull
   public DebtStatement getSource()
   {
      return sourceProperty().get();
   }

   public final void setSource(DebtStatement source)
   {
      if (source == null)
      {
         source = new DebtStatement();
      }
   ...
   public boolean equals(Object obj)
   {
      ...
      if (getClass() != obj.getClass())
         return false;
      DebtStatementCustomerInvoiceAssoc other = (DebtStatementCustomerInvoiceAssoc) obj;
      if (id == other.id)
         return true;
      if (id == null)
