...
@Singleton
public class WareHouseController extends DomainComponentController
{

   @Inject
   private WareHouseSearchController searchController;

   @Inject
   private WareHouseCreateController createController;

   @Inject
   private WareHouseEditController editController;

   @Inject
   private WareHouseListController listController;

   @Inject
   private WareHouseDisplayController displayController;

   @Inject
   private WareHouseIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<WareHouse> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<WareHouse> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<WareHouse> selectedModelEvent;

   private WareHouse createModel = new WareHouse();
   private WareHouse searchModel = new WareHouse();
   private WareHouse selectedModel = new WareHouse();
    ...
    * @param entities
    */
   public void handleSearchResult(@Observes @EntitySearchDoneEvent List<WareHouse> entities)
   {
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent WareHouse selectedEntity)
   {
      if (!registration.canRead())
         return;
      List<EntityController> displayedViews = getDisplayedViews();
    ...
    */
   public void handleCreateRequestedEvent(@Observes @EntityCreateRequestedEvent WareHouse templateEntity)
   {
   ...
   public void handleEditRequestedEvent(@Observes @EntityEditRequestedEvent WareHouse selectedEntity)
   {
