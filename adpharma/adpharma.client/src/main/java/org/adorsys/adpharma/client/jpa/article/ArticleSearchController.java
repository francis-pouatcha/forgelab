...
@Singleton
public class ArticleSearchController implements EntityController
{
   ...
   private Event<ArticleSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Article templateEntity)
   {
   ...
   private ArticleSearchInput buildSearchInputs()
   {
      ArticleSearchInput result = new ArticleSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Article model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent ArticleSearchResult searchResult)
   {
