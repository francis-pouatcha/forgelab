...
public class InventoryAgency implements Association<Inventory, Agency>, Cloneable
{
   ...
   public InventoryAgency()
   {
   }

   public InventoryAgency(Agency entity)
   {
   ...
   //			return false;
   //		InventoryAgency other = (InventoryAgency) obj;
