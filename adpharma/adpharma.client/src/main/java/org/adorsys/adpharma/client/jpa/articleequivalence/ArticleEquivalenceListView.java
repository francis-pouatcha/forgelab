...
public class ArticleEquivalenceListView
{
   ...
   @FXML
   private TableView<ArticleEquivalence> dataList;
   ...
   public TableView<ArticleEquivalence> getDataList()
   {
      return dataList;
   }
