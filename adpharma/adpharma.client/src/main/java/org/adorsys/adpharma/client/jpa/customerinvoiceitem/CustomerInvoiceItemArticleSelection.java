...
public class CustomerInvoiceItemArticleSelection extends AbstractSelection<CustomerInvoiceItem, Article>
{
   ...
   public void postConstruct()
   {
      ...
      article = viewBuilder.addComboBox("CustomerInvoiceItem_article_description.title", "article", resourceBundle, false);
      ...
      article.setCellFactory(new Callback<ListView<Article>, ListCell<Article>>()
      {
         ...
         {
            return new CustomerInvoiceItemArticleListCell();
         }
      });
      article.setButtonCell(new CustomerInvoiceItemArticleListCell());
