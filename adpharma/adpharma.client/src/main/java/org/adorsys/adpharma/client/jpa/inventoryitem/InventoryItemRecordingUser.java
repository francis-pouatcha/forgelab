...
public class InventoryItemRecordingUser implements Association<InventoryItem, Login>, Cloneable
{
   ...
   public InventoryItemRecordingUser()
   {
   }

   public InventoryItemRecordingUser(Login entity)
   {
   ...
   //			return false;
   //		InventoryItemRecordingUser other = (InventoryItemRecordingUser) obj;
   ...
   {
      InventoryItemRecordingUser a = new InventoryItemRecordingUser();
      a.id = id;
      a.version = version;
