...
public class InventoryItemArticle implements Association<InventoryItem, Article>, Cloneable
{
   ...
   public InventoryItemArticle(Article entity)
   {
   ...
   //			return false;
   //		InventoryItemArticle other = (InventoryItemArticle) obj;
   ...
   {
      InventoryItemArticle a = new InventoryItemArticle();
      a.id = id;
      a.version = version;
