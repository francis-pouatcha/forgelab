...
@Singleton
public class DeliveryItemCreateController implements EntityController
{

   @Inject
   private DeliveryItemCreateView createView;

   @Inject
   private DeliveryItemCreateService createService;
   @Inject
   private ServiceCallFailedEventHandler createServiceCallFailedEventHandler;

   @Inject
   @EntityCreateDoneEvent
   private Event<DeliveryItem> createDoneEvent;
   ...
   public void init()
   {
      ...
      createView.getSaveButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            Set<ConstraintViolation<DeliveryItem>> violations = createView.getView().validate(model);
