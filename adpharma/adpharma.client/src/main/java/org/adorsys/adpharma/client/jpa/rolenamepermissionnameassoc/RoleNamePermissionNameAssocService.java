...
public class RoleNamePermissionNameAssocService
{
   ...
   public RoleNamePermissionNameAssocService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/rolenamepermissionnameassocs");
   }
   ...
   {
      Entity<RoleNamePermissionNameAssoc> eCopy = Entity.entity(entity, media);
      return target.request(media).post(eCopy, RoleNamePermissionNameAssoc.class);
   }
   ...
   {//@PathParam("id")
      // TODO encode id
      return target.path("" + id).request(media).delete(RoleNamePermissionNameAssoc.class);
   }
   ...
   public RoleNamePermissionNameAssoc update(RoleNamePermissionNameAssoc entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, RoleNamePermissionNameAssoc.class);
   }
   ...
   {// @PathParam("id") 
      return target.path("" + id).request(media).get(RoleNamePermissionNameAssoc.class);
   }
   ...
   {
      return target.request(media).get(RoleNamePermissionNameAssocSearchResult.class);
   }
   ...
   public RoleNamePermissionNameAssocSearchResult listAll(int start, int max)
   {
      return target.queryParam("start", start).queryParam("max", max)
            .request(media).get(RoleNamePermissionNameAssocSearchResult.class);
   }
   ...
   {
      Entity<RoleNamePermissionNameAssocSearchInput> searchInputEntity = Entity.entity(
            searchInput, media);
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, RoleNamePermissionNameAssocSearchResult.class);
   }
