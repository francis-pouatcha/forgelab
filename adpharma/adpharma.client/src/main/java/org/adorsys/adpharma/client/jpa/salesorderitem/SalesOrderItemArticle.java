...
public class SalesOrderItemArticle implements Association<SalesOrderItem, Article>, Cloneable
{
   ...
   public SalesOrderItemArticle(Article entity)
   {
   ...
   //			return false;
   //		SalesOrderItemArticle other = (SalesOrderItemArticle) obj;
   ...
   {
      SalesOrderItemArticle a = new SalesOrderItemArticle();
      a.id = id;
      a.version = version;
