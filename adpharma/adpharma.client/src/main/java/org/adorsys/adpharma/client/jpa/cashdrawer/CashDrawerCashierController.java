...
public abstract class CashDrawerCashierController
{
   @Inject
   ...
   protected void disableButton(final CashDrawerCashierSelection selection)
   {
      selection.getCashier().setDisable(true);
   }

   protected void activateButton(final CashDrawerCashierSelection selection)
   {
   }
