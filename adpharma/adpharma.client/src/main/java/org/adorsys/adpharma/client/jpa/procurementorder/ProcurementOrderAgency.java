...
public class ProcurementOrderAgency implements Association<ProcurementOrder, Agency>, Cloneable
{
   ...
   public ProcurementOrderAgency()
   {
   }

   public ProcurementOrderAgency(Agency entity)
   {
   ...
   //			return false;
   //		ProcurementOrderAgency other = (ProcurementOrderAgency) obj;
   ...
   {
      ProcurementOrderAgency a = new ProcurementOrderAgency();
      a.id = id;
      a.version = version;
