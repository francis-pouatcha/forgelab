...
@Singleton
public class SectionSearchController implements EntityController
{
   ...
   private Event<SectionSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Section templateEntity)
   {
   ...
   private SectionSearchInput buildSearchInputs()
   {
      SectionSearchInput result = new SectionSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Section model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent SectionSearchResult searchResult)
   {
