...
public class DocumentArchiveRecordingUser implements Association<DocumentArchive, Login>, Cloneable
{
   ...
   public DocumentArchiveRecordingUser()
   {
   }

   public DocumentArchiveRecordingUser(Login entity)
   {
   ...
   //			return false;
   //		DocumentArchiveRecordingUser other = (DocumentArchiveRecordingUser) obj;
   ...
   {
      DocumentArchiveRecordingUser a = new DocumentArchiveRecordingUser();
      a.id = id;
      a.version = version;
