...
public class CashOutCashDrawerForm extends AbstractToOneAssociation<CashOut, CashDrawer>
{
...
//	      closingDate = viewBuilder.addCalendarTextField("CashDrawer_closingDate_description.title", "closingDate", resourceBundle, "dd-MM-yyyy HH:mm", locale);
	   ...
	   {
	      cashDrawerNumber.textProperty().bindBidirectional(model.getCasDrawer().cashDrawerNumberProperty());
	      opened.textProperty().bindBidirectional(model.getCasDrawer().openedProperty(), new BooleanStringConverter());
	      initialAmount.numberProperty().bindBidirectional(model.getCasDrawer().initialAmountProperty());
//	      totalCashIn.numberProperty().bindBidirectional(model.getCasDrawer().totalCashInProperty());
//	      totalCashOut.numberProperty().bindBidirectional(model.getCasDrawer().totalCashOutProperty());
//	      totalCash.numberProperty().bindBidirectional(model.getCasDrawer().totalCashProperty());
//	      totalCheck.numberProperty().bindBidirectional(model.getCasDrawer().totalCheckProperty());
//	      totalCreditCard.numberProperty().bindBidirectional(model.getCasDrawer().totalCreditCardProperty());
//	      totalCompanyVoucher.numberProperty().bindBidirectional(model.getCasDrawer().totalCompanyVoucherProperty());
//	      totalClientVoucher.numberProperty().bindBidirectional(model.getCasDrawer().totalClientVoucherProperty());
//	      openingDate.calendarProperty().bindBidirectional(model.getCasDrawer().openingDateProperty());
//	      closingDate.calendarProperty().bindBidirectional(model.getCasDrawer().closingDateProperty());
	   }

	   public void update(CashOutCashDrawer data)
	   {
