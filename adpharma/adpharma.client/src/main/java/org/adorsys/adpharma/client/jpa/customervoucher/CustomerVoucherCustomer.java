...
public class CustomerVoucherCustomer implements Association<CustomerVoucher, Customer>, Cloneable
{
   ...
   public CustomerVoucherCustomer()
   {
   }

   public CustomerVoucherCustomer(Customer entity)
   {
   ...
   //			return false;
   //		CustomerVoucherCustomer other = (CustomerVoucherCustomer) obj;
   ...
   {
      CustomerVoucherCustomer a = new CustomerVoucherCustomer();
      a.id = id;
      a.version = version;
