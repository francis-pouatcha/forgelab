...
public class ProcurementOrderItemCreatingUser implements Association<ProcurementOrderItem, Login>, Cloneable
{
   ...
   public ProcurementOrderItemCreatingUser()
   {
   }

   public ProcurementOrderItemCreatingUser(Login entity)
   {
   ...
   //			return false;
   //		ProcurementOrderItemCreatingUser other = (ProcurementOrderItemCreatingUser) obj;
   ...
   {
      ProcurementOrderItemCreatingUser a = new ProcurementOrderItemCreatingUser();
      a.id = id;
      a.version = version;
