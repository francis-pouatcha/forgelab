...
@Singleton
public class LoginController extends DomainComponentController
{

   @Inject
   private LoginSearchController searchController;

   @Inject
   private LoginCreateController createController;

   @Inject
   private LoginEditController editController;

   @Inject
   private LoginListController listController;

   @Inject
   private LoginDisplayController displayController;

   @Inject
   private LoginIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<Login> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<Login> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<Login> selectedModelEvent;

   private Login createModel = new Login();
