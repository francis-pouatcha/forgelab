...
public class ArticleLotVat implements Association<ArticleLot, VAT>, Cloneable
{
   ...
   public ArticleLotVat()
   {
   }

   public ArticleLotVat(VAT entity)
   {
   ...
   //			return false;
   //		ArticleLotVat other = (ArticleLotVat) obj;
   ...
   {
      ArticleLotVat a = new ArticleLotVat();
      a.id = id;
      a.version = version;
