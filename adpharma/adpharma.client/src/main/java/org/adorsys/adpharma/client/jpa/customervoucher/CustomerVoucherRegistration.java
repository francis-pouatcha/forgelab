...
@Eager
@Singleton
public class CustomerVoucherRegistration extends DomainComponentRegistration
{

   @Inject
   @Bundle(CustomerVoucher.class)
   ...
   {
      return CustomerVoucherController.class;
   }

   @Override
   protected String getComponentI18nName()
   {
      Description annotation = CustomerVoucher.class.getAnnotation(Description.class);
      if (annotation != null)
         return resourceBundle.getString(annotation.value() + ".title");
      return CustomerVoucher.class.getName();
   }

   @Override
   public String getComponentPermission()
   {
      return "org.adorsys.adpharma.server.jpa.CustomerVoucher";
   }
