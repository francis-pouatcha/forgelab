...
public class CashOutCashDrawer implements Association<CashOut, CashDrawer>, Cloneable {
	private Long id;
	private int version;
	...
	public CashOutCashDrawer()
	{
	}

	public CashOutCashDrawer(CashDrawer entity)
	{
	...
	{
		CashOutCashDrawer a = new CashOutCashDrawer();
		a.id = id;
		a.version = version;
