...
@Singleton
public class PrescriberSearchController implements EntityController
{

   @Inject
   private PrescriberSearchView searchView;
   ...
   private Event<PrescriberSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            PrescriberSearchService s = (PrescriberSearchService) event.getSource();
            PrescriberSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Prescriber(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Prescriber templateEntity)
   {
   ...
   private PrescriberSearchInput buildSearchInputs()
   {
      PrescriberSearchInput result = new PrescriberSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Prescriber model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent PrescriberSearchResult searchResult)
   {
