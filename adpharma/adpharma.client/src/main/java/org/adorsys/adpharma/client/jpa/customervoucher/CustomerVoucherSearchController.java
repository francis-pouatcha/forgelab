...
@Singleton
public class CustomerVoucherSearchController implements EntityController
{

   @Inject
   private CustomerVoucherSearchView searchView;

   @Inject
   private CustomerVoucherSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<CustomerVoucherSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new CustomerVoucher(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent CustomerVoucher templateEntity)
   {
   ...
   private CustomerVoucherSearchInput buildSearchInputs()
   {
      CustomerVoucherSearchInput result = new CustomerVoucherSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent CustomerVoucher model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CustomerVoucherSearchResult searchResult)
   {
