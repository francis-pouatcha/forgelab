...
public class StockMovementService
{
   ...
   public StockMovementService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/stockmovements");
   }
   ...
   {//@PathParam("id")
      // TODO encode id
      return target.path("" + id).request(media).delete(StockMovement.class);
   }
   ...
   public StockMovement update(StockMovement entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, StockMovement.class);
   }
   ...
   public StockMovementSearchResult findBy(StockMovementSearchInput searchInput)
   {
      ...
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, StockMovementSearchResult.class);
   }
