...
public class CompanySearchController implements EntityController
{
   ...
   @Inject
   private CompanySearchView searchView;
   ...
   private Event<CompanySearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            CompanySearchService s = (CompanySearchService) event.getSource();
            CompanySearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Company templateEntity)
   {
   ...
   private CompanySearchInput buildSearchInputs()
   {
      CompanySearchInput result = new CompanySearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Company model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CompanySearchResult searchResult)
   {
