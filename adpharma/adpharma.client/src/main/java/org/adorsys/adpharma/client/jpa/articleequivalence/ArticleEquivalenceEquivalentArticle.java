...
public class ArticleEquivalenceEquivalentArticle implements Association<ArticleEquivalence, Article>, Cloneable
{
   ...
   public ArticleEquivalenceEquivalentArticle()
   {
   }

   public ArticleEquivalenceEquivalentArticle(Article entity)
   {
   ...
   //			return false;
   //		ArticleEquivalenceEquivalentArticle other = (ArticleEquivalenceEquivalentArticle) obj;
   ...
   {
      ArticleEquivalenceEquivalentArticle a = new ArticleEquivalenceEquivalentArticle();
      a.id = id;
      a.version = version;
