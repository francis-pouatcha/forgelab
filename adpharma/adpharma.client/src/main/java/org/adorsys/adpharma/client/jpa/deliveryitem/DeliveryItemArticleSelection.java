...
public class DeliveryItemArticleSelection extends AbstractSelection<DeliveryItem, Article>
{
   ...
   public void postConstruct()
   {
      ...
      article = viewBuilder.addComboBox("DeliveryItem_article_description.title", "article", resourceBundle, false);
      ...
      article.setCellFactory(new Callback<ListView<Article>, ListCell<Article>>()
      {
         ...
         {
            return new DeliveryItemArticleListCell();
         }
      });
      article.setButtonCell(new DeliveryItemArticleListCell());
