...
public class SectionAgency implements Association<Section, Agency>, Cloneable
{
   ...
   public SectionAgency()
   {
   }

   public SectionAgency(Agency entity)
   {
   ...
   //			return false;
   //		SectionAgency other = (SectionAgency) obj;
   ...
   {
      SectionAgency a = new SectionAgency();
      a.id = id;
      a.version = version;
