...
public class ProductDetailConfigSource implements Association<ProductDetailConfig, Article>, Cloneable
{
   ...
   public ProductDetailConfigSource()
   {
   }

   public ProductDetailConfigSource(Article entity)
   {
   ...
   //			return false;
   //		ProductDetailConfigSource other = (ProductDetailConfigSource) obj;
   ...
   {
      ProductDetailConfigSource a = new ProductDetailConfigSource();
      a.id = id;
      a.version = version;
