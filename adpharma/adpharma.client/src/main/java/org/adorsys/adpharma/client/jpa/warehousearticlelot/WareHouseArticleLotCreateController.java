...
@Singleton
public class WareHouseArticleLotCreateController implements EntityController
{

   @Inject
   private WareHouseArticleLotCreateView createView;

   @Inject
   private WareHouseArticleLotCreateService createService;
   @Inject
   private ServiceCallFailedEventHandler createServiceCallFailedEventHandler;

   @Inject
   @EntityCreateDoneEvent
   private Event<WareHouseArticleLot> createDoneEvent;
   ...
   public void init()
   {
      ...
      createView.getSaveButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            Set<ConstraintViolation<WareHouseArticleLot>> violations = createView.getView().validate(model);
      ...
      createService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            WareHouseArticleLotCreateService s = (WareHouseArticleLotCreateService) event.getSource();
