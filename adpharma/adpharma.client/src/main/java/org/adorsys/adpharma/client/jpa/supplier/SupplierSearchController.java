...
@Singleton
public class SupplierSearchController implements EntityController
{

   @Inject
   private SupplierSearchView searchView;
   ...
   private Event<SupplierSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            SupplierSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Supplier(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Supplier templateEntity)
   {
   ...
   private SupplierSearchInput buildSearchInputs()
   {
      SupplierSearchInput result = new SupplierSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Supplier model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent SupplierSearchResult searchResult)
   {
