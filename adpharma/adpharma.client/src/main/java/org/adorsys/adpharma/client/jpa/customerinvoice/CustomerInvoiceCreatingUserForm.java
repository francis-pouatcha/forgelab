...
public class CustomerInvoiceCreatingUserForm extends AbstractToOneAssociation<CustomerInvoice, Login>
{
   ...
   public void update(CustomerInvoiceCreatingUser data)
   {
