...
public class SupplierInvoiceCreatingUser implements Association<SupplierInvoice, Login>, Cloneable
{
   ...
   public SupplierInvoiceCreatingUser()
   {
   }

   public SupplierInvoiceCreatingUser(Login entity)
   {
   ...
   //			return false;
   //		SupplierInvoiceCreatingUser other = (SupplierInvoiceCreatingUser) obj;
   ...
   {
      SupplierInvoiceCreatingUser a = new SupplierInvoiceCreatingUser();
      a.id = id;
      a.version = version;
