...
public abstract class PaymentAgencyController
{
   @Inject
   ...
   protected void disableButton(final PaymentAgencySelection selection)
   {
      selection.getAgency().setDisable(true);
   }

   protected void activateButton(final PaymentAgencySelection selection)
   {
   }
