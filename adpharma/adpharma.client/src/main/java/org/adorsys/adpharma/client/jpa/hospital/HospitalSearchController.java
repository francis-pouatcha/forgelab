...
@Singleton
public class HospitalSearchController implements EntityController
{

   @Inject
   private HospitalSearchView searchView;
   ...
   private Event<HospitalSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            HospitalSearchService s = (HospitalSearchService) event.getSource();
            HospitalSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Hospital(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Hospital templateEntity)
   {
   ...
   private HospitalSearchInput buildSearchInputs()
   {
      HospitalSearchInput result = new HospitalSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Hospital model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent HospitalSearchResult searchResult)
   {
