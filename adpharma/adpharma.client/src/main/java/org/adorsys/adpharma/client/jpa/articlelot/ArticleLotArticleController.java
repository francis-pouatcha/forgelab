...
public abstract class ArticleLotArticleController
{
   ...
   protected void disableButton(final ArticleLotArticleSelection selection)
   {
      selection.getArticle().setDisable(true);
   }

   protected void activateButton(final ArticleLotArticleSelection selection)
   {
   }

   protected void bind(final ArticleLotArticleSelection selection)
   {
      ...
      selection.getArticle().valueProperty().addListener(new ChangeListener<Article>()
      {
               ...
               Article newValue)
         {
            if (sourceEntity != null)
               sourceEntity.setArticle(new ArticleLotArticle(newValue));
         }
      });
