...
public abstract class ArticleLotArticleController
{
   ...
   private Event<ArticleLotArticleSelectionEventData> selectionRequestEvent;

   private ArticleLotArticleSelectionEventData pendingSelectionRequest;
   ...
   protected void disableButton(final ArticleLotArticleSelection selection, final ArticleLotArticleForm form)
   {
      selection.getSelectButton().setDisable(true);
   }

   protected void activateButton(final ArticleLotArticleSelection selection, final ArticleLotArticleForm form)
   {
   }

   protected void bind(final ArticleLotArticleSelection selection, final ArticleLotArticleForm form)
   {
      selection.getSelectButton().setOnAction(
            new EventHandler<ActionEvent>()
            {
               ...
               {
                  pendingSelectionRequest = new ArticleLotArticleSelectionEventData(
      ...
      loadService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            event.consume();
            s.reset();
            sourceEntity.setArticle(new ArticleLotArticle(entity));
         }
      });
   ...
   public void handleAssocSelectionResponseEvent(@Observes @AssocSelectionResponseEvent ArticleLotArticleSelectionEventData eventData)
   {
            ...
            && eventData.getSourceEntity() == sourceEntity && eventData.getTargetEntity() != null)
      {
         if (sourceEntity != null)
            sourceEntity.setArticle(new ArticleLotArticle(eventData.getTargetEntity()));
      }
      componentSelectionRequestEvent.fire(new ComponentSelectionRequestData(ArticleLot.class.getName()));
   }
