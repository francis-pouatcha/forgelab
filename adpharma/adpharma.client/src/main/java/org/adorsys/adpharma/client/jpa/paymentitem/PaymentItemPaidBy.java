...
public class PaymentItemPaidBy implements Association<PaymentItem, Customer>, Cloneable
{
   ...
   public PaymentItemPaidBy()
   {
   }

   public PaymentItemPaidBy(Customer entity)
   {
   ...
   //			return false;
   //		PaymentItemPaidBy other = (PaymentItemPaidBy) obj;
   ...
   {
      PaymentItemPaidBy a = new PaymentItemPaidBy();
      a.id = id;
      a.version = version;
