...
@Singleton
public class DebtStatementSearchController implements EntityController
{

   @Inject
   private DebtStatementSearchView searchView;
   ...
   private Event<DebtStatementSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new DebtStatement(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent DebtStatement templateEntity)
   {
   ...
   private DebtStatementSearchInput buildSearchInputs()
   {
      DebtStatementSearchInput result = new DebtStatementSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent DebtStatement model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent DebtStatementSearchResult searchResult)
   {
