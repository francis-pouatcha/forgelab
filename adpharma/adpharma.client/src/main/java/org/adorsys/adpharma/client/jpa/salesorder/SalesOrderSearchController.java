...
@Singleton
public class SalesOrderSearchController implements EntityController
{

   @Inject
   private SalesOrderSearchView searchView;
   ...
   private Event<SalesOrderSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new SalesOrder(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent SalesOrder templateEntity)
   {
   ...
   private SalesOrderSearchInput buildSearchInputs()
   {
      SalesOrderSearchInput result = new SalesOrderSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent SalesOrder model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent SalesOrderSearchResult searchResult)
   {
