...
@Singleton
public class CustomerInvoiceItemSearchController implements EntityController
{

   @Inject
   private CustomerInvoiceItemSearchView searchView;
   ...
   private Event<CustomerInvoiceItemSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent CustomerInvoiceItem templateEntity)
   {
   ...
   private CustomerInvoiceItemSearchInput buildSearchInputs()
   {
      CustomerInvoiceItemSearchInput result = new CustomerInvoiceItemSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent CustomerInvoiceItem model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CustomerInvoiceItemSearchResult searchResult)
   {
