...
public class DocumentStoreRecordingUser implements Association<DocumentStore, Login>, Cloneable
{
   ...
   public DocumentStoreRecordingUser()
   {
   }

   public DocumentStoreRecordingUser(Login entity)
   {
   ...
   //			return false;
   //		DocumentStoreRecordingUser other = (DocumentStoreRecordingUser) obj;
   ...
   {
      DocumentStoreRecordingUser a = new DocumentStoreRecordingUser();
      a.id = id;
      a.version = version;
