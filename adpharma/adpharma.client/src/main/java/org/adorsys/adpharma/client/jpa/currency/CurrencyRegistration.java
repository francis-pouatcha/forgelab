...
@Eager
@Singleton
public class CurrencyRegistration extends DomainComponentRegistration
{

   @Inject
   @Bundle(Currency.class)
   ...
   {
      Description annotation = Currency.class.getAnnotation(Description.class);
      if (annotation != null)
   ...
   {
      return "org.adorsys.adpharma.server.jpa.Currency";
   }
