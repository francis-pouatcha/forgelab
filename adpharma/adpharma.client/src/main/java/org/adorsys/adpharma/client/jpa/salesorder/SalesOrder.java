...
public class SalesOrder implements Cloneable
{
	...
	private SimpleBooleanProperty alreadyReturned;
	...
	public SimpleBooleanProperty alreadyReturnedProperty()
	{
		if (alreadyReturned == null)
		{
			alreadyReturned = new SimpleBooleanProperty(Boolean.FALSE);
		}
	...
	{
		return alreadyReturnedProperty().get();
	}

	public final void setAlreadyReturned(Boolean alreadyReturned)
	{
		if (alreadyReturned == null)
			alreadyReturned = Boolean.FALSE;
		this.alreadyReturnedProperty().set(alreadyReturned);
	}
	...
	public SimpleObjectProperty<DocumentProcessingState> salesOrderStatusProperty()
	{
		...
		{
			salesOrderStatus = new SimpleObjectProperty<DocumentProcessingState>(DocumentProcessingState.ONGOING);
		}
