...
public class SalesOrder
{
	...
	private SimpleBooleanProperty cashed = new SimpleBooleanProperty(Boolean.FALSE);
	...
	private SimpleObjectProperty<SalesOrderType> salesOrderType = new SimpleObjectProperty<SalesOrderType>(SalesOrderType.CASH_SALE);
	@Description("SalesOrder_amountBeforeTax_description")
	@NumberFormatType(NumberType.CURRENCY)
	private SimpleObjectProperty<BigDecimal> amountBeforeTax =  new SimpleObjectProperty<BigDecimal>(BigDecimal.ZERO);
	@Description("SalesOrder_amountVAT_description")
	@NumberFormatType(NumberType.CURRENCY)
	private SimpleObjectProperty<BigDecimal> amountVAT =  new SimpleObjectProperty<BigDecimal>(BigDecimal.ZERO);
	@Description("SalesOrder_amountDiscount_description")
	@NumberFormatType(NumberType.CURRENCY)
	private SimpleObjectProperty<BigDecimal> amountDiscount =  new SimpleObjectProperty<BigDecimal>(BigDecimal.ZERO);
	@Description("SalesOrder_totalReturnAmount_description")
	@NumberFormatType(NumberType.CURRENCY)
	private SimpleObjectProperty<BigDecimal> totalReturnAmount =  new SimpleObjectProperty<BigDecimal>(BigDecimal.ZERO);
	@Description("SalesOrder_amountAfterTax_description")
	@NumberFormatType(NumberType.CURRENCY)
	private SimpleObjectProperty<BigDecimal> amountAfterTax =  new SimpleObjectProperty<BigDecimal>(BigDecimal.ZERO);
