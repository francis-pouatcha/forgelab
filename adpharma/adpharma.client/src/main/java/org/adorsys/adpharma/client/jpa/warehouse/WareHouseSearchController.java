...
public class WareHouseSearchController implements EntityController {
	...
	@Inject
	private WareHouseSearchView searchView;
	...
	private Event<WareHouseSearchResult> searchDoneEvent;
	...
	private WareHouseSearchInput buildSearchInputs() {
		WareHouseSearchInput result = new WareHouseSearchInput();
