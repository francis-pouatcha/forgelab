...
public class CustomerVoucherCustomerInvoice implements Association<CustomerVoucher, CustomerInvoice>, Cloneable
{
   ...
   {
      CustomerVoucherCustomerInvoice a = new CustomerVoucherCustomerInvoice();
      a.id = id;
      a.version = version;
