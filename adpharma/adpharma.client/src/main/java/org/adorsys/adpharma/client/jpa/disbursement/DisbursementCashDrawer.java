...
public class DisbursementCashDrawer implements Association<Disbursement, CashDrawer>, Cloneable {
	private Long id;
	private int version;
	...
	public DisbursementCashDrawer()
	{
	}

	public DisbursementCashDrawer(CashDrawer entity)
	{
	...
	{
		DisbursementCashDrawer a = new DisbursementCashDrawer();
		a.id = id;
		a.version = version;
