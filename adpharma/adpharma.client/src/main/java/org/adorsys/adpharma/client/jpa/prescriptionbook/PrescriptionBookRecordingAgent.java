...
public class PrescriptionBookRecordingAgent implements Association<PrescriptionBook, Login>, Cloneable
{
   ...
   {
      PrescriptionBookRecordingAgent a = new PrescriptionBookRecordingAgent();
      a.id = id;
      a.version = version;
