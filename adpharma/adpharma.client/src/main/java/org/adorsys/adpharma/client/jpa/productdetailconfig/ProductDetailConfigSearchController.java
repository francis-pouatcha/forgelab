...
@Singleton
public class ProductDetailConfigSearchController implements EntityController
{

   @Inject
   private ProductDetailConfigSearchView searchView;

   @Inject
   private ProductDetailConfigSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<ProductDetailConfigSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent ProductDetailConfig templateEntity)
   {
   ...
   private ProductDetailConfigSearchInput buildSearchInputs()
   {
      ProductDetailConfigSearchInput result = new ProductDetailConfigSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent ProductDetailConfig model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent ProductDetailConfigSearchResult searchResult)
   {
