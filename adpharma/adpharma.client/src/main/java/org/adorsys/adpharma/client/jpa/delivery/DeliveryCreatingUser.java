...
public class DeliveryCreatingUser implements Association<Delivery, Login>, Cloneable
{
   ...
   public DeliveryCreatingUser()
   {
   }

   public DeliveryCreatingUser(Login entity)
   {
   ...
   //			return false;
   //		DeliveryCreatingUser other = (DeliveryCreatingUser) obj;
   ...
   {
      DeliveryCreatingUser a = new DeliveryCreatingUser();
      a.id = id;
      a.version = version;
