...
public class ArticleView extends AbstractForm<Article>
{
   ...
   private BigDecimalField minStockQty;
   ...
   public void postConstruct()
   {
      ...
      minStockQty = viewBuilder.addBigDecimalField("Article_minStockQty_description.title", "minStockQty", resourceBundle, NumberType.INTEGER, locale);
...
//      viewBuilder.addSubForm("Article_vat_description.title", "vat", resourceBundle, articleVatForm, ViewModel.READ_ONLY);
   ...
   public void bind(Article model)
   {
      ...
      minStockQty.numberProperty().bindBidirectional(model.minStockQtyProperty());
...
//      recordingDate.calendarProperty().bindBidirectional(model.recordingDateProperty());
   ...
   public BigDecimalField getMinStockQty()
   {
      return minStockQty;
   }
