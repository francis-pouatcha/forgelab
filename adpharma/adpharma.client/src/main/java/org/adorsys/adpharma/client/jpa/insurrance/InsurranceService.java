...
public class InsurranceService
{
   ...
   public InsurranceService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/insurrances");
   }
   ...
   public Insurrance update(Insurrance entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, Insurrance.class);
   }
   ...
   public InsurranceSearchResult findBy(InsurranceSearchInput searchInput)
   {
      ...
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, InsurranceSearchResult.class);
   }
