...
@Singleton
public class ArticleLotCreateController implements EntityController
{

   @Inject
   private ArticleLotCreateView createView;

   @Inject
   private ArticleLotCreateService createService;
   @Inject
   private ServiceCallFailedEventHandler createServiceCallFailedEventHandler;

   @Inject
   @EntityCreateDoneEvent
   private Event<ArticleLot> createDoneEvent;
   ...
   public void init()
   {
      ...
      createView.getSaveButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            Set<ConstraintViolation<ArticleLot>> violations = createView.getView().validate(model);
      ...
      createService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            ArticleLotCreateService s = (ArticleLotCreateService) event.getSource();
