...
public class CashOutCashier implements Association<CashOut, Login>, Cloneable{
	 private Long id;
	   private int version;
	   ...
	   public CashOutCashier()
	   {
	   }

	   public CashOutCashier(Login entity)
	   {
	   ...
	   {
		   CashOutCashier a = new CashOutCashier();
	      a.id = id;
	      a.version = version;
