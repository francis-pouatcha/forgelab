...
@Singleton
public class AgencySearchController implements EntityController
{

   @Inject
   private AgencySearchView searchView;
   ...
   private Event<AgencySearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Agency(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Agency templateEntity)
   {
   ...
   private AgencySearchInput buildSearchInputs()
   {
      AgencySearchInput result = new AgencySearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Agency model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent AgencySearchResult searchResult)
   {
