...
@Singleton
public class SalesOrderItemSearchController implements EntityController
{

   @Inject
   private SalesOrderItemSearchView searchView;
   ...
   private Event<SalesOrderItemSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new SalesOrderItem(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent SalesOrderItem templateEntity)
   {
   ...
   private SalesOrderItemSearchInput buildSearchInputs()
   {
      SalesOrderItemSearchInput result = new SalesOrderItemSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent SalesOrderItem model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent SalesOrderItemSearchResult searchResult)
   {
