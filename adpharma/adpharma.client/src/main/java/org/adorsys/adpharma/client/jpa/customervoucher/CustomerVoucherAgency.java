...
public class CustomerVoucherAgency implements Association<CustomerVoucher, Agency>, Cloneable
{
   ...
   public CustomerVoucherAgency()
   {
   }

   public CustomerVoucherAgency(Agency entity)
   {
   ...
   //			return false;
   //		CustomerVoucherAgency other = (CustomerVoucherAgency) obj;
   ...
   {
      CustomerVoucherAgency a = new CustomerVoucherAgency();
      a.id = id;
      a.version = version;
