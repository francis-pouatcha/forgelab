...
public class CashOutAgency implements Association<CashOut, Agency>, Cloneable {
	 private Long id;
	   private int version;
	   ...
	   public CashOutAgency()
	   {
	   }

	   public CashOutAgency(Agency entity)
	   {
	   ...
	   {
		   CashOutAgency a = new CashOutAgency();
	      a.id = id;
	      a.version = version;
