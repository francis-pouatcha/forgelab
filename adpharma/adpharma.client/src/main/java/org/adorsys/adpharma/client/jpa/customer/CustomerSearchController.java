...
@Singleton
public class CustomerSearchController implements EntityController
{
   ...
   private Event<CustomerSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Customer templateEntity)
   {
   ...
   private CustomerSearchInput buildSearchInputs()
   {
      CustomerSearchInput result = new CustomerSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Customer model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CustomerSearchResult searchResult)
   {
