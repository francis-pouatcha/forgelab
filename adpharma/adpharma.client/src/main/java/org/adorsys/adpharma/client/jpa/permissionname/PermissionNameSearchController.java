...
@Singleton
public class PermissionNameSearchController implements EntityController
{

   @Inject
   private PermissionNameSearchView searchView;

   @Inject
   private PermissionNameSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<PermissionNameSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            PermissionNameSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent PermissionName templateEntity)
   {
   ...
   private PermissionNameSearchInput buildSearchInputs()
   {
      PermissionNameSearchInput result = new PermissionNameSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent PermissionName model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent PermissionNameSearchResult searchResult)
   {
