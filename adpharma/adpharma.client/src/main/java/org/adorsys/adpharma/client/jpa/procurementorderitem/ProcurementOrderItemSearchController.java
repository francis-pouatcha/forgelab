...
@Singleton
public class ProcurementOrderItemSearchController implements EntityController
{

   @Inject
   private ProcurementOrderItemSearchView searchView;
   ...
   private Event<ProcurementOrderItemSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new ProcurementOrderItem(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent ProcurementOrderItem templateEntity)
   {
   ...
   private ProcurementOrderItemSearchInput buildSearchInputs()
   {
      ProcurementOrderItemSearchInput result = new ProcurementOrderItemSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent ProcurementOrderItem model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent ProcurementOrderItemSearchResult searchResult)
   {
