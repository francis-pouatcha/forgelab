...
@Singleton
public class RoleNameSearchController implements EntityController
{

   @Inject
   private RoleNameSearchView searchView;

   @Inject
   private RoleNameSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<RoleNameSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            RoleNameSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new RoleName(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent RoleName templateEntity)
   {
   ...
   private RoleNameSearchInput buildSearchInputs()
   {
      RoleNameSearchInput result = new RoleNameSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent RoleName model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent RoleNameSearchResult searchResult)
   {
