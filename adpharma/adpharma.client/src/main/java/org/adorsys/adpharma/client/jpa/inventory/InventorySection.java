...
public class InventorySection implements Association<Inventory, Section>, Cloneable
{
	...
	public InventorySection(Section entity)
	{
	...
	{
		InventorySection a = new InventorySection();
		a.id = id;
		a.version = version;
