...
public abstract class DebtStatementInsurranceController
{

   protected DebtStatement sourceEntity;
   ...
   private Event<DebtStatementInsurranceSelectionEventData> selectionRequestEvent;

   private DebtStatementInsurranceSelectionEventData pendingSelectionRequest;
   ...
   protected void disableButton(final DebtStatementInsurranceSelection selection, final DebtStatementInsurranceForm form)
   {
      selection.getSelectButton().setDisable(true);
   }

   protected void activateButton(final DebtStatementInsurranceSelection selection, final DebtStatementInsurranceForm form)
   {
   }

   protected void bind(final DebtStatementInsurranceSelection selection, final DebtStatementInsurranceForm form)
   {
      selection.getSelectButton().setOnAction(
            new EventHandler<ActionEvent>()
            {
               ...
               {
                  pendingSelectionRequest = new DebtStatementInsurranceSelectionEventData(
      ...
      loadService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            event.consume();
            s.reset();
            sourceEntity.setInsurrance(new DebtStatementInsurrance(entity));
         }
      });
   ...
   public void handleAssocSelectionResponseEvent(@Observes @AssocSelectionResponseEvent DebtStatementInsurranceSelectionEventData eventData)
   {
            ...
            && eventData.getSourceEntity() == sourceEntity && eventData.getTargetEntity() != null)
      {
         if (sourceEntity != null)
            sourceEntity.setInsurrance(new DebtStatementInsurrance(eventData.getTargetEntity()));
      }
