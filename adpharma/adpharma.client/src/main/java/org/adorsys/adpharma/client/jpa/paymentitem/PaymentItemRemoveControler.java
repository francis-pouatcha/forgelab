...
public class PaymentItemRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<PaymentItem> removedEvent;
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent PaymentItem entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent PaymentItem entity)
   {
