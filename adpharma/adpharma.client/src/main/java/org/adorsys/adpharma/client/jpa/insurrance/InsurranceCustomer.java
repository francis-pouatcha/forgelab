...
public class InsurranceCustomer implements Association<Insurrance, Customer>, Cloneable
{
   ...
   public InsurranceCustomer(Customer entity)
   {
   ...
   //			return false;
   //		InsurranceCustomer other = (InsurranceCustomer) obj;
   ...
   {
      InsurranceCustomer a = new InsurranceCustomer();
      a.id = id;
      a.version = version;
