...
public class SupplierInvoiceItemInvoice implements Association<SupplierInvoiceItem, SupplierInvoice>, Cloneable
{
   ...
   {
      SupplierInvoiceItemInvoice a = new SupplierInvoiceItemInvoice();
      a.id = id;
      a.version = version;
