...
@Singleton
public class CustomerEditController implements EntityController
{
   ...
   @Inject
   private CustomerEditService editService;
   @Inject
   ...
   private Event<Customer> editCanceledEvent;

   @Inject
   @EntityEditDoneEvent
   private Event<Customer> editedDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      editService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            CustomerEditService s = (CustomerEditService) event.getSource();
