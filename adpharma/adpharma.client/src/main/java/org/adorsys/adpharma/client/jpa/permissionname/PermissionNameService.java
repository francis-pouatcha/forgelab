...
public class PermissionNameService
{
   ...
   public PermissionNameService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/permissionnames");
   }
   ...
   public PermissionName update(PermissionName entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, PermissionName.class);
   }
   ...
   public PermissionNameSearchResult findBy(PermissionNameSearchInput searchInput)
   {
      ...
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, PermissionNameSearchResult.class);
   }
