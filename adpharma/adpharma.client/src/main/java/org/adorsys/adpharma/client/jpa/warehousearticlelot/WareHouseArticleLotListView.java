...
public class WareHouseArticleLotListView
{
	...
	public void postConstruct()
	{
		...
		viewBuilder.addStringColumn(dataList, "articleName", "WareHouseArticleLot_articleName_description.title", resourceBundle);
		viewBuilder.addStringColumn(dataList, "wareHouse", "WareHouseArticleLot_wareHouse_description.title", resourceBundle);
