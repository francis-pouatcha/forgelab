...
public class LoginView extends AbstractForm<Login>
{
	...
	private BigDecimalField simulationRate;
	...
	public void postConstruct()
	{
		...
		simulationRate = viewBuilder.addBigDecimalField("Login_simulationRate_description.title", "simulationRate", resourceBundle, NumberType.INTEGER, locale);
	...
	public void bind(Login model)
	{
		...
		simulationRate.numberProperty().bindBidirectional(model.simulationRateProperty());
