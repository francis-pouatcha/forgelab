...
@Singleton
public class CustomerCategoryController extends DomainComponentController
{

   @Inject
   private CustomerCategorySearchController searchController;

   @Inject
   private CustomerCategoryCreateController createController;

   @Inject
   private CustomerCategoryEditController editController;

   @Inject
   private CustomerCategoryListController listController;

   @Inject
   private CustomerCategoryDisplayController displayController;

   @Inject
   private CustomerCategoryIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<CustomerCategory> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<CustomerCategory> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<CustomerCategory> selectedModelEvent;

   private CustomerCategory createModel = new CustomerCategory();
   ...
   /**
    * Display search form.
    * @param selectedCustomerCategory
    */
