...
public class ProcurementOrderItemArticle implements Association<ProcurementOrderItem, Article>, Cloneable
{
   ...
   public ProcurementOrderItemArticle()
   {
   }

   public ProcurementOrderItemArticle(Article entity)
   {
   ...
   //			return false;
   //		ProcurementOrderItemArticle other = (ProcurementOrderItemArticle) obj;
   ...
   {
      ProcurementOrderItemArticle a = new ProcurementOrderItemArticle();
      a.id = id;
      a.version = version;
