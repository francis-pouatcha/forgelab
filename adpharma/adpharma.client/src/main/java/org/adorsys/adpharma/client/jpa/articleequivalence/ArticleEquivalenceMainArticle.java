...
public class ArticleEquivalenceMainArticle implements Association<ArticleEquivalence, Article>, Cloneable
{
   ...
   public ArticleEquivalenceMainArticle()
   {
   }

   public ArticleEquivalenceMainArticle(Article entity)
   {
   ...
   //			return false;
   //		ArticleEquivalenceMainArticle other = (ArticleEquivalenceMainArticle) obj;
   ...
   {
      ArticleEquivalenceMainArticle a = new ArticleEquivalenceMainArticle();
      a.id = id;
      a.version = version;
