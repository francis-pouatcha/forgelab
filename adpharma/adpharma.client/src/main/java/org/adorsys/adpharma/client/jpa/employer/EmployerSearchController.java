...
@Singleton
public class EmployerSearchController implements EntityController
{

   @Inject
   private EmployerSearchView searchView;
   ...
   private Event<EmployerSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            EmployerSearchService s = (EmployerSearchService) event.getSource();
            EmployerSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Employer(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Employer templateEntity)
   {
   ...
   private EmployerSearchInput buildSearchInputs()
   {
      EmployerSearchInput result = new EmployerSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Employer model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent EmployerSearchResult searchResult)
   {
