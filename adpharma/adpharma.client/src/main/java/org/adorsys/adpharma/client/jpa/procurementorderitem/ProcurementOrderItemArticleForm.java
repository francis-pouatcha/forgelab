...
public class ProcurementOrderItemArticleForm extends AbstractToOneAssociation<ProcurementOrderItem, Article>
{
   ...
   public void update(ProcurementOrderItemArticle data)
   {
