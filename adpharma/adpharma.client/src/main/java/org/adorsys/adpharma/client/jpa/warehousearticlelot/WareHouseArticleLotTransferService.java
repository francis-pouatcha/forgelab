...
public class WareHouseArticleLotTransferService extends Service<WareHouseArticleLot>
{
	   ...
	   public WareHouseArticleLotTransferService setModel(ArticleLotTransferManager model)
	   {
	      this.model = model;
	      return this;
	   }
