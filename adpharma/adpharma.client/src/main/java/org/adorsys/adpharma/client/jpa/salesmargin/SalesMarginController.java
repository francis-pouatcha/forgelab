...
@Singleton
public class SalesMarginController extends DomainComponentController
{

   @Inject
   private SalesMarginSearchController searchController;

   @Inject
   private SalesMarginCreateController createController;

   @Inject
   private SalesMarginEditController editController;

   @Inject
   private SalesMarginListController listController;

   @Inject
   private SalesMarginDisplayController displayController;

   @Inject
   private SalesMarginIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<SalesMargin> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<SalesMargin> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<SalesMargin> selectedModelEvent;

   private SalesMargin createModel = new SalesMargin();
   private SalesMargin searchModel = new SalesMargin();
   private SalesMargin selectedModel = new SalesMargin();
    ...
    * @param entities
    */
   public void handleSearchResult(@Observes @EntitySearchDoneEvent List<SalesMargin> entities)
   {
    ...
    */
   public void handleSelectionEvent(@Observes @EntitySelectionEvent SalesMargin selectedEntity)
   {
      // if result is empty: display no result.
      // else display list of salesMargins.
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent SalesMargin selectedEntity)
   {
      List<EntityController> displayedViews = getDisplayedViews();
      displayedViews.clear();
   ...
   /**
    * Display search form.
    * @param selectedSalesMargin
    */
   public void handleCreateRequestedEvent(@Observes @EntityCreateRequestedEvent SalesMargin templateEntity)
   {
      List<EntityController> displayedViews = getDisplayedViews();
      displayedViews.clear();
      displayedViews.add(listController);
   ...
   public void handleEditRequestedEvent(@Observes @EntityEditRequestedEvent SalesMargin selectedEntity)
   {
      List<EntityController> displayedViews = getDisplayedViews();
      displayedViews.clear();
      displayedViews.add(listController);
