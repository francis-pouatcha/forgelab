...
@Singleton
public class PaymentItemSearchController implements EntityController
{

   @Inject
   private PaymentItemSearchView searchView;
   ...
   private Event<PaymentItemSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            PaymentItemSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new PaymentItem(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent PaymentItem templateEntity)
   {
   ...
   private PaymentItemSearchInput buildSearchInputs()
   {
      PaymentItemSearchInput result = new PaymentItemSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent PaymentItem model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent PaymentItemSearchResult searchResult)
   {
