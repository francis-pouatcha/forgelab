...
public class PrescriptionBookSalesOrder implements Association<PrescriptionBook, SalesOrder>, Cloneable
{
   ...
   public PrescriptionBookSalesOrder()
   {
   }

   public PrescriptionBookSalesOrder(SalesOrder entity)
   {
   ...
   //			return false;
   //		PrescriptionBookSalesOrder other = (PrescriptionBookSalesOrder) obj;
   ...
   {
      PrescriptionBookSalesOrder a = new PrescriptionBookSalesOrder();
      a.id = id;
      a.version = version;
