...
public class CustomerInvoiceAgency implements Association<CustomerInvoice, Agency>, Cloneable
{
   ...
   public CustomerInvoiceAgency()
   {
   }

   public CustomerInvoiceAgency(Agency entity)
   {
   ...
   //			return false;
   //		CustomerInvoiceAgency other = (CustomerInvoiceAgency) obj;
   ...
   {
      CustomerInvoiceAgency a = new CustomerInvoiceAgency();
      a.id = id;
      a.version = version;
