...
@Singleton
public class CashDrawerSearchController implements EntityController
{

   @Inject
   private CashDrawerSearchView searchView;
   ...
   private Event<CashDrawerSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            CashDrawerSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new CashDrawer(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent CashDrawer templateEntity)
   {
   ...
   private CashDrawerSearchInput buildSearchInputs()
   {
      CashDrawerSearchInput result = new CashDrawerSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent CashDrawer model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CashDrawerSearchResult searchResult)
   {
