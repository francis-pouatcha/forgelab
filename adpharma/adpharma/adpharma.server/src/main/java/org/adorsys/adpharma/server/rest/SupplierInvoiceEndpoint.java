...
public class SupplierInvoiceEndpoint
{
   ...
   private static final List<String> supplierFields = Arrays.asList("name", "fax", "email", "agency.name");
   ...
   private static final List<String> deliveryFields = Arrays.asList("deliveryNumber", "deliverySlipNumber", "dateOnDeliverySlip", "agency.name", "amountBeforeTax", "amountAfterTax", "amountDiscount", "netAmountToPay", "vat.rate", "receivingAgency.name");

   private static final List<String> invoiceItemsFields = Arrays.asList("internalPic", "article.articleName", "indexLine", "deliveryQty", "purchasePricePU", "salesPricePU", "amountReturn", "totalSalesPrice");
