...
public class ProcurementOrderEndpoint
{
   ...
   private static final List<String> procurementOrderItemsFields = Arrays.asList("lineIndex", "internalPic", "mainPic", "secondaryPic", "articleName", "article.articleName", "expirationDate", "qtyOrdered", "freeQuantity", "stockQuantity", "salesPricePU", "purchasePricePU", "totalPurchasePrice", "valid");
