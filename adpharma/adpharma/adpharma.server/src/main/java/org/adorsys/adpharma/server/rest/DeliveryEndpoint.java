...
public class DeliveryEndpoint
{
   ...
   private static final List<String> deliveryItemsFields = Arrays.asList("internalPic", "secondaryPic", "mainPic", "article.articleName", "articleName", "initialQty", "finalQty", "totalPurchasingPrice", "totalDiscount", "totalSalesPrice");
