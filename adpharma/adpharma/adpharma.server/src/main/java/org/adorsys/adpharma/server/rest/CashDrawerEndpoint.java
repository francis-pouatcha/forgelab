...
public class CashDrawerEndpoint
{
   ...
   private static final List<String> cashierFields = Arrays.asList("loginName", "email");

   private static final List<String> closedByFields = Arrays.asList("loginName", "email");
