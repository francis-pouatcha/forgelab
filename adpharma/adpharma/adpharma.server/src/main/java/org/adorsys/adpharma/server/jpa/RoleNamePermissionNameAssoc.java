...
@RelationshipTable
public class RoleNamePermissionNameAssoc implements Serializable
{
   ...
   private RoleName source;

   @ManyToOne
   @NotNull
   @JoinColumn(name = "target_id")
   private PermissionName target;
   ...
   public void setSource(RoleName source)
   {
      this.source = source;
   }
   ...
   public void setTarget(PermissionName target)
   {
      this.target = target;
   }
