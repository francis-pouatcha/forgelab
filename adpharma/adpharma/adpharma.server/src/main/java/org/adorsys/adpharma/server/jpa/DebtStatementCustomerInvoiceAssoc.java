...
@RelationshipTable
public class DebtStatementCustomerInvoiceAssoc implements Serializable
{
   ...
   private CustomerInvoice target;
   ...
   public void setSource(DebtStatement source)
   {
      this.source = source;
   }
   ...
   public void setTarget(CustomerInvoice target)
   {
      this.target = target;
   }
