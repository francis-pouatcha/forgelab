...
public class ArticleEndpoint
{
   ...
   private static final List<String> sectionFields = Arrays.asList("sectionCode", "name", "displayName", "position", "agency.name");

   private static final List<String> familyFields = Arrays.asList("code", "name");
