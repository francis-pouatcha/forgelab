...
public class CustomerInvoiceCustomerSelection extends AbstractSelection<CustomerInvoice, Customer>
{
   ...
   public void postConstruct()
   {
      ...
      customer = viewBuilder.addComboBox("CustomerInvoice_customer_description.title", "customer", resourceBundle, false);
      ...
      customer.setCellFactory(new Callback<ListView<Customer>, ListCell<Customer>>()
      {
         ...
         {
            return new CustomerInvoiceCustomerListCell();
         }
      });
      customer.setButtonCell(new CustomerInvoiceCustomerListCell());
