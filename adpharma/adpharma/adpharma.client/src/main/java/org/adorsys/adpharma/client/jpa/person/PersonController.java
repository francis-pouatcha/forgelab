...
@Singleton
public class PersonController extends DomainComponentController
{

   @Inject
   private PersonSearchController searchController;

   @Inject
   private PersonCreateController createController;

   @Inject
   private PersonEditController editController;

   @Inject
   private PersonListController listController;

   @Inject
   private PersonDisplayController displayController;

   @Inject
   private PersonIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<Person> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<Person> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<Person> selectedModelEvent;

   private Person createModel = new Person();
   private Person searchModel = new Person();
   private Person selectedModel = new Person();
    ...
    * @param entities
    */
   public void handleSearchResult(@Observes @EntitySearchDoneEvent List<Person> entities)
   {
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Person selectedEntity)
   {
      List<EntityController> displayedViews = getDisplayedViews();
      displayedViews.clear();
   ...
   public void handleEditRequestedEvent(@Observes @EntityEditRequestedEvent Person selectedEntity)
   {
      List<EntityController> displayedViews = getDisplayedViews();
      displayedViews.clear();
      displayedViews.add(listController);
