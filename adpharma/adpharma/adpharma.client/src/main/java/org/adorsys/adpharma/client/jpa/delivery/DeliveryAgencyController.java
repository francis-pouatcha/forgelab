...
public abstract class DeliveryAgencyController
{
   @Inject
   ...
   protected void disableButton(final DeliveryAgencySelection selection)
   {
      selection.getAgency().setDisable(true);
   }

   protected void activateButton(final DeliveryAgencySelection selection)
   {
   }

   protected void bind(final DeliveryAgencySelection selection)
   {
      ...
      selection.getAgency().valueProperty().addListener(new ChangeListener<Agency>()
      {
               ...
               Agency newValue)
         {
            if (sourceEntity != null)
               sourceEntity.setAgency(new DeliveryAgency(newValue));
         }
      });
