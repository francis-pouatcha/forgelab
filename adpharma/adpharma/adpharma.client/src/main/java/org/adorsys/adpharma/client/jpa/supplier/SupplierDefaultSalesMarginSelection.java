...
public class SupplierDefaultSalesMarginSelection extends AbstractSelection<Supplier, SalesMargin>
{
   ...
   public void postConstruct()
   {
      ...
      defaultSalesMargin = viewBuilder.addComboBox("Supplier_defaultSalesMargin_description.title", "defaultSalesMargin", resourceBundle, false);
      ...
      defaultSalesMargin.setCellFactory(new Callback<ListView<SalesMargin>, ListCell<SalesMargin>>()
      {
         ...
         {
            return new SupplierDefaultSalesMarginListCell();
         }
      });
      defaultSalesMargin.setButtonCell(new SupplierDefaultSalesMarginListCell());
