...
@Singleton
public class ProductFamilySearchController implements EntityController
{

   @Inject
   private ProductFamilySearchView searchView;
   ...
   private Event<ProductFamilySearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new ProductFamily(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent ProductFamily templateEntity)
   {
   ...
   private ProductFamilySearchInput buildSearchInputs()
   {
      ProductFamilySearchInput result = new ProductFamilySearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent ProductFamily model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent ProductFamilySearchResult searchResult)
   {
