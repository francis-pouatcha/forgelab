...
public class CustomerCategoryService
{
   ...
   public CustomerCategoryService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/customercategorys");
   }
   ...
   {//@PathParam("id")
      // TODO encode id
      return target.path("" + id).request(media).delete(CustomerCategory.class);
   }
   ...
   public CustomerCategory update(CustomerCategory entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, CustomerCategory.class);
   }
   ...
   {// @PathParam("id") 
      return target.path("" + id).request(media).get(CustomerCategory.class);
   }
   ...
   public CustomerCategorySearchResult findBy(CustomerCategorySearchInput searchInput)
   {
      ...
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, CustomerCategorySearchResult.class);
   }
