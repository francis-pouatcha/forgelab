...
public class SupplierInvoiceItemService
{
   ...
   public SupplierInvoiceItemService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/supplierinvoiceitems");
   }
   ...
   {//@PathParam("id")
      // TODO encode id
      return target.path("" + id).request(media).delete(SupplierInvoiceItem.class);
   }
   ...
   public SupplierInvoiceItem update(SupplierInvoiceItem entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, SupplierInvoiceItem.class);
   }
   ...
   {// @PathParam("id") 
      return target.path("" + id).request(media).get(SupplierInvoiceItem.class);
   }
   ...
   {
      return target.request(media).get(SupplierInvoiceItemSearchResult.class);
   }
   ...
   {
      Entity<SupplierInvoiceItemSearchInput> searchInputEntity = Entity.entity(
            searchInput, media);
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, SupplierInvoiceItemSearchResult.class);
   }
