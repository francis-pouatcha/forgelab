...
@Singleton
public class PersonSearchController implements EntityController
{

   @Inject
   private PersonSearchView searchView;
   ...
   private Event<PersonSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            PersonSearchService s = (PersonSearchService) event.getSource();
            PersonSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Person(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Person templateEntity)
   {
   ...
   private PersonSearchInput buildSearchInputs()
   {
      PersonSearchInput result = new PersonSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Person model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent PersonSearchResult searchResult)
   {
