...
public class SupplierAgency implements Association<Supplier, Agency>
{
   ...
   public SupplierAgency()
   {
   }

   public SupplierAgency(Agency entity)
   {
   ...
   public boolean equals(Object obj)
   {
      ...
      if (getClass() != obj.getClass())
         return false;
      SupplierAgency other = (SupplierAgency) obj;
      if (id == other.id)
         return true;
      if (id == null)
