...
@Singleton
public class SupplierInvoiceItemSearchController implements EntityController
{

   @Inject
   private SupplierInvoiceItemSearchView searchView;
   ...
   private Event<SupplierInvoiceItemSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            SupplierInvoiceItemSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new SupplierInvoiceItem(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent SupplierInvoiceItem templateEntity)
   {
   ...
   private SupplierInvoiceItemSearchInput buildSearchInputs()
   {
      SupplierInvoiceItemSearchInput result = new SupplierInvoiceItemSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent SupplierInvoiceItem model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent SupplierInvoiceItemSearchResult searchResult)
   {
