...
public class DeliveryView extends AbstractForm<Delivery>
{
   ...
   @Inject
   private DeliveryAgencyForm deliveryAgencyForm;
   @Inject
   private DeliveryAgencySelection deliveryAgencySelection;
   ...
   public void postConstruct()
   {
      ...
      viewBuilder.addTitlePane("Delivery_agency_description.title", resourceBundle);
      viewBuilder.addSubForm("Delivery_agency_description.title", "agency", resourceBundle, deliveryAgencyForm, ViewModel.READ_ONLY);
      viewBuilder.addSubForm("Delivery_agency_description.title", "agency", resourceBundle, deliveryAgencySelection, ViewModel.READ_WRITE);
      ...
      viewBuilder.addTitlePane("Delivery_receivingAgency_description.title", resourceBundle);
   ...
   public void bind(Delivery model)
   {
      ...
      deliveryAgencyForm.bind(model);
      deliveryAgencySelection.bind(model);
   ...
   public DeliveryAgencyForm getDeliveryAgencyForm()
   {
      return deliveryAgencyForm;
   }

   public DeliveryAgencySelection getDeliveryAgencySelection()
   {
      return deliveryAgencySelection;
   }
