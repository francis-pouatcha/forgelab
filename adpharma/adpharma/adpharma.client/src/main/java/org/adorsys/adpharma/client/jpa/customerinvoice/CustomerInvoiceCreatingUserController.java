...
public abstract class CustomerInvoiceCreatingUserController
{
   @Inject
   ...
   protected void disableButton(final CustomerInvoiceCreatingUserSelection selection)
   {
      selection.getCreatingUser().setDisable(true);
   }

   protected void activateButton(final CustomerInvoiceCreatingUserSelection selection)
   {
   }
