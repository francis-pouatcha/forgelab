...
@Singleton
public class CustomerInvoiceSearchController implements EntityController
{

   @Inject
   private CustomerInvoiceSearchView searchView;
   ...
   private Event<CustomerInvoiceSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new CustomerInvoice(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent CustomerInvoice templateEntity)
   {
   ...
   private CustomerInvoiceSearchInput buildSearchInputs()
   {
      CustomerInvoiceSearchInput result = new CustomerInvoiceSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent CustomerInvoice model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CustomerInvoiceSearchResult searchResult)
   {
