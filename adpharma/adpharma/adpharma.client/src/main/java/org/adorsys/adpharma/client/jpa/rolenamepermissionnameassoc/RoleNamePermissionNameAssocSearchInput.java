...
public class RoleNamePermissionNameAssocSearchInput
{
   ...
   public RoleNamePermissionNameAssoc getEntity()
   {
      return entity;
   }

   public void setEntity(RoleNamePermissionNameAssoc entity)
   {
      this.entity = entity;
   }
