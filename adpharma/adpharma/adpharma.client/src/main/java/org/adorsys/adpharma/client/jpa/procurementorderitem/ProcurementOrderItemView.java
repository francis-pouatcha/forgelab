...
public class ProcurementOrderItemView extends AbstractForm<ProcurementOrderItem>
{
   ...
   {
      internalPic.focusedProperty().addListener(new TextInputControlFoccusChangedListener<ProcurementOrderItem>(textInputControlValidator, internalPic, ProcurementOrderItem.class, "internalPic", resourceBundle));
   ...
   public Set<ConstraintViolation<ProcurementOrderItem>> validate(ProcurementOrderItem model)
   {
      ...
      violations.addAll(textInputControlValidator.validate(internalPic, ProcurementOrderItem.class, "internalPic", resourceBundle));
