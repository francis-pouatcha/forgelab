...
public class CustomerInvoiceItemRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<CustomerInvoiceItem> removedEvent;
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent CustomerInvoiceItem entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent CustomerInvoiceItem entity)
   {
