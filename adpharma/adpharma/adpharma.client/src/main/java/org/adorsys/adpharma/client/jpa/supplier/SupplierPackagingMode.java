...
public class SupplierPackagingMode implements Association<Supplier, PackagingMode>
{
   ...
   public SupplierPackagingMode()
   {
   }

   public SupplierPackagingMode(PackagingMode entity)
   {
   ...
   public boolean equals(Object obj)
   {
      ...
      if (getClass() != obj.getClass())
         return false;
      SupplierPackagingMode other = (SupplierPackagingMode) obj;
      if (id == other.id)
         return true;
      if (id == null)
