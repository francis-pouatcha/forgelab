...
public abstract class ProcurementOrderAgencyController
{
   @Inject
   ...
   protected void disableButton(final ProcurementOrderAgencySelection selection)
   {
      selection.getAgency().setDisable(true);
   }

   protected void activateButton(final ProcurementOrderAgencySelection selection)
   {
   }
