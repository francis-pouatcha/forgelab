...
public abstract class SupplierAgencyController
{
   @Inject
   ...
   protected void disableButton(final SupplierAgencySelection selection)
   {
      selection.getAgency().setDisable(true);
   }

   protected void activateButton(final SupplierAgencySelection selection)
   {
   }

   protected void bind(final SupplierAgencySelection selection)
   {
      ...
      selection.getAgency().valueProperty().addListener(new ChangeListener<Agency>()
      {
               ...
               Agency newValue)
         {
            if (sourceEntity != null)
               sourceEntity.setAgency(new SupplierAgency(newValue));
         }
      });
