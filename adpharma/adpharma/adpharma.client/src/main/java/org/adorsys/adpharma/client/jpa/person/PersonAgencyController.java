...
public abstract class PersonAgencyController
{
   @Inject
   ...
   @Inject
   @Bundle({ CrudKeys.class, Agency.class, Person.class })
   ...
   protected void disableButton(final PersonAgencySelection selection)
   {
      selection.getAgency().setDisable(true);
   }

   protected void activateButton(final PersonAgencySelection selection)
   {
   }

   protected void bind(final PersonAgencySelection selection)
   {
      ...
      selection.getAgency().valueProperty().addListener(new ChangeListener<Agency>()
      {
               ...
               Agency newValue)
         {
            if (sourceEntity != null)
               sourceEntity.setAgency(new PersonAgency(newValue));
         }
      });
