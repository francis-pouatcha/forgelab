...
@ListField({ "deliveryNumber", "deliverySlipNumber", "dateOnDeliverySlip",
      "agency.name", "amountBeforeTax", "amountAfterTax", "amountDiscount",
...
public class Delivery
{
   ...
   @Description("Delivery_agency_description")
   @Association(selectionMode = SelectionMode.COMBOBOX, associationType = AssociationType.AGGREGATION, targetEntity = Agency.class)
   private SimpleObjectProperty<DeliveryAgency> agency;
   ...
   public SimpleObjectProperty<DeliveryAgency> agencyProperty()
   {
      if (agency == null)
      {
         agency = new SimpleObjectProperty<DeliveryAgency>(new DeliveryAgency());
      }
      return agency;
   }

   public DeliveryAgency getAgency()
   {
      return agencyProperty().get();
   }

   public final void setAgency(DeliveryAgency agency)
   {
      if (agency == null)
      {
