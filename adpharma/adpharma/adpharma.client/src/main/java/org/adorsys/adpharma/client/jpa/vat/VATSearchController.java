...
@Singleton
public class VATSearchController implements EntityController
{

   @Inject
   private VATSearchView searchView;
   ...
   private Event<VATSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         public void handle(WorkerStateEvent event)
         {
            ...
            VATSearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new VAT(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent VAT templateEntity)
   {
   ...
   private VATSearchInput buildSearchInputs()
   {
      VATSearchInput result = new VATSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent VAT model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent VATSearchResult searchResult)
   {
