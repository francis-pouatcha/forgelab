...
@Singleton
public class PrescriptionBookSearchController implements EntityController
{

   @Inject
   private PrescriptionBookSearchView searchView;

   @Inject
   private PrescriptionBookSearchService searchService;
   @Inject
   private ServiceCallFailedEventHandler searchServiceCallFailedEventHandler;

   @Inject
   @EntitySearchDoneEvent
   private Event<PrescriptionBookSearchResult> searchDoneEvent;
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent PrescriptionBook templateEntity)
   {
   ...
   private PrescriptionBookSearchInput buildSearchInputs()
   {
      PrescriptionBookSearchInput result = new PrescriptionBookSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent PrescriptionBook model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent PrescriptionBookSearchResult searchResult)
   {
