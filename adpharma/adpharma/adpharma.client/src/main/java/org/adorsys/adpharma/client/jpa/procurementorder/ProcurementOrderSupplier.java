...
import org.adorsys.adpharma.client.jpa.supplier.SupplierDefaultSalesMargin;
import javafx.beans.property.SimpleObjectProperty;
import org.adorsys.adpharma.client.jpa.packagingmode.PackagingMode;
import org.adorsys.adpharma.client.jpa.supplier.SupplierPackagingMode;
...
import org.adorsys.adpharma.client.jpa.supplier.SupplierClearanceConfig;
...
public class ProcurementOrderSupplier implements Association<ProcurementOrder, Supplier>
{
   ...
   public ProcurementOrderSupplier()
   {
   }

   public ProcurementOrderSupplier(Supplier entity)
   {
   ...
   public boolean equals(Object obj)
   {
      ...
      if (getClass() != obj.getClass())
         return false;
      ProcurementOrderSupplier other = (ProcurementOrderSupplier) obj;
      if (id == other.id)
         return true;
      if (id == null)
