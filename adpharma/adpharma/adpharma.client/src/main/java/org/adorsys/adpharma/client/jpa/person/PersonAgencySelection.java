...
public class PersonAgencySelection extends AbstractSelection<Person, Agency>
{
   ...
   public void postConstruct()
   {
      ...
      agency = viewBuilder.addComboBox("Person_agency_description.title", "agency", resourceBundle, false);
      ...
      agency.setCellFactory(new Callback<ListView<Agency>, ListCell<Agency>>()
      {
         ...
         {
            return new PersonAgencyListCell();
         }
      });
      agency.setButtonCell(new PersonAgencyListCell());
