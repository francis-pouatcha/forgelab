...
@Singleton
public class SalesMarginSearchController implements EntityController
{

   @Inject
   private SalesMarginSearchView searchView;
   ...
   private Event<SalesMarginSearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new SalesMargin(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent SalesMargin templateEntity)
   {
   ...
   private SalesMarginSearchInput buildSearchInputs()
   {
      SalesMarginSearchInput result = new SalesMarginSearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent SalesMargin model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent SalesMarginSearchResult searchResult)
   {
