...
public class CustomerVoucherService
{
   ...
   public CustomerVoucherService()
   {
      ...
      this.target = client.target(serverAddress + "/rest/customervouchers");
   }
   ...
   {//@PathParam("id")
      // TODO encode id
      return target.path("" + id).request(media).delete(CustomerVoucher.class);
   }
   ...
   public CustomerVoucher update(CustomerVoucher entity)
   {
      ...
      return target.path("" + entity.getId())
            .request(media).put(ent, CustomerVoucher.class);
   }
   ...
   public CustomerVoucherSearchResult findBy(CustomerVoucherSearchInput searchInput)
   {
      ...
      return target.path(FIND_BY).request(media).post(
            searchInputEntity, CustomerVoucherSearchResult.class);
   }
