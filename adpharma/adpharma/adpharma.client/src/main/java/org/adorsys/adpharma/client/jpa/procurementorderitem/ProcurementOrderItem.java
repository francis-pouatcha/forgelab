...
@ListField({ "lineIndex", "internalPic", "mainPic", "secondaryPic",
      "articleName", "article.articleName", "expirationDate", "qtyOrdered",
      "freeQuantity", "stockQuantity", "salesPricePU", "purchasePricePU",
      "totalPurchasePrice", "valid" })
...
public class ProcurementOrderItem
{
   ...
   @Description("ProcurementOrderItem_lineIndex_description")
   private SimpleStringProperty lineIndex;
   @Description("ProcurementOrderItem_internalPic_description")
   ...
   public SimpleStringProperty lineIndexProperty()
   {
      if (lineIndex == null)
      {
         lineIndex = new SimpleStringProperty();
      }
      return lineIndex;
   }
   ...
   {
      return lineIndexProperty().get();
   }

   public final void setLineIndex(String lineIndex)
   {
      this.lineIndexProperty().set(lineIndex);
   }
   ...
   @Size(min = 7, message = "ProcurementOrderItem_internalPic_Size_validation")
