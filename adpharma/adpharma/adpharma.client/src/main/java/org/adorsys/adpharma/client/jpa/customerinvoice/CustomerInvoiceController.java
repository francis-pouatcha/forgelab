...
@Singleton
public class CustomerInvoiceController extends DomainComponentController
{

   @Inject
   private CustomerInvoiceSearchController searchController;

   @Inject
   private CustomerInvoiceCreateController createController;

   @Inject
   private CustomerInvoiceEditController editController;

   @Inject
   private CustomerInvoiceListController listController;

   @Inject
   private CustomerInvoiceDisplayController displayController;

   @Inject
   private CustomerInvoiceIntialScreenController intialScreenController;

   @Inject
   @CreateModelEvent
   private Event<CustomerInvoice> createModelEvent;
   @Inject
   @SearchModelEvent
   private Event<CustomerInvoice> searchModelEvent;
   @Inject
   @SelectedModelEvent
   private Event<CustomerInvoice> selectedModelEvent;

   private CustomerInvoice createModel = new CustomerInvoice();
