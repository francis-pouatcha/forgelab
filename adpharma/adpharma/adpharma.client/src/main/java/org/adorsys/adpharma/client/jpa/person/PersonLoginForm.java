...
public class PersonLoginForm extends AbstractToOneAssociation<Person, Login>
{
   ...
   {
      loginName.textProperty().bindBidirectional(model.getLogin().loginNameProperty());
      email.textProperty().bindBidirectional(model.getLogin().emailProperty());
   }
