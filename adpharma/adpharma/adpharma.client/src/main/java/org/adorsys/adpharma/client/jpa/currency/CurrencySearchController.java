...
@Singleton
public class CurrencySearchController implements EntityController
{

   @Inject
   private CurrencySearchView searchView;
   ...
   private Event<CurrencySearchResult> searchDoneEvent;
   ...
   public void postConstruct()
   {
      ...
      searchService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            CurrencySearchService s = (CurrencySearchService) event.getSource();
            CurrencySearchResult searchResult = s.getValue();
            event.consume();
            s.reset();
      ...
      searchView.getResetButton().setOnAction(new EventHandler<ActionEvent>()
      {
         ...
         public void handle(ActionEvent e)
         {
            PropertyReader.copy(new Currency(), model);
         }
      });
    ...
    */
   public void handleSearchRequestedEvent(@Observes @EntitySearchRequestedEvent Currency templateEntity)
   {
   ...
   private CurrencySearchInput buildSearchInputs()
   {
      CurrencySearchInput result = new CurrencySearchInput();
   ...
   public void handleNewModelEvent(@Observes @SearchModelEvent Currency model)
   {
      this.model = model;
      searchView.bind(this.model);
   }

   public void handleEntityListPageIndexChangedEvent(@Observes @EntityListPageIndexChangedEvent CurrencySearchResult searchResult)
   {
