...
public class PermissionNameRemoveControler
{

   @Inject
   @EntityRemoveDoneEvent
   private Event<PermissionName> removedEvent;

   @Inject
   private PermissionNameRemoveService removeService;
   @Inject
   ...
   public void handleRemoveRequest(
         @Observes @EntityRemoveRequestEvent PermissionName entity)
   {
      this.entity = entity;
   ...
   public void handleRemoveOkEvent(
         @Observes @EntityRemoveConfirmedEvent PermissionName entity)
   {
   ...
   public void postConstruct()
   {
      ...
      removeService.setOnSucceeded(new EventHandler<WorkerStateEvent>()
      {
         ...
         {
            PermissionNameRemoveService service = (PermissionNameRemoveService) wse
                  .getSource();
            PermissionName p = service.getValue();
            wse.consume();
            service.reset();
            removedEvent.fire(p);
         }
